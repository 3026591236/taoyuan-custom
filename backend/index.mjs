  ...
  updateLogs: [
    {
      ...
      title: "V2.9.8 仙身动态浮光",
      content:
        "仙界大厅角色立绘增加动态仙身表现：角色会轻微悬浮、呼吸缩放和左右衣袂摆动，脚下灵光随节奏脉冲；动态层独立于舞台与境界特效，不改变玩法数值和入口。",
    },
    {
      date: "2026-07-12",
    ...
    },
    {
      ...
      content:
        "参考五行修真的成神之路、每日重置与集中福利结构，不照搬数值、不新增地图入口，而是在活动中心新增修行路总览与今日重置推荐清单。修行路把桃源初立、引气修行、红尘历练、宗门立身、转生筑基、飞升仙界、裂隙镇狱等既有系统按阶段串联，显示已完成、当前推荐与后续解锁；今日指引集中提示每日目标、周修行令、全服镇魔、世界剧情、宗门材料和仙界日常，帮助玩家上线后知道先做什么。",
    },
    {
      date: "2026-07-11",
    ...
    {
      date: "2026-07-11",
      title: "V2.8.7 宗门副本与长老试炼",
      content:
        "本次从仙界线横向巡检已有玩法，优先补齐宗门系统闭环：宗门页新增宗门副本·长老试炼，不新增凡界地图入口。亲传弟子可按所入宗门挑战剑冢镇妖、丹霞药境、天罡符阵，消耗宗门贡献并根据职位、试剑台等底蕴结算功勋、灵气和专属材料；长老候补可每日挑战长老试炼，获得玉简、法宝碎片、功勋与灵气。宗门宝库秘境材料匣说明同步调整，宗门职位从“后续接副本”改为已接入副本闭环。",
    },
    {
      date: "2026-07-11",
      title: "V2.8.6 裂隙轮值词缀",
    ...
    },
    {
      ...
      title: "V2.2.0 自动打坐调息",
      content:
        "修行页新增“后台自动打坐调息”按钮，玩家开启后会定时自动执行打坐调息，无需反复手动点击；过程中会正常消耗体力并获得修为、灵力和灵气收益，切换到背包、农场、商圈等页面仍会继续运行，体力不足时自动暂停，适合挂机修炼和减少重复操作。",
    },
    {
      date: "2026-07-10",
      title: "V2.1.9 知识库补充",
      content:
        "继续补充游戏内知识库，新增悬浮福利领取、福利按钮看不到、每日/七日福利重置、商圈打不开、登仙塔卡层、排行榜名字特效、村庄回响、玩家拍卖、宗门经营、丹药使用、物品异常、反馈补偿、V2.1.3~V2.1.8版本说明和战斗Build选择等条目，方便玩家直接搜索近期反馈问题和新系统玩法。",
    },
    {
      date: "2026-07-10",
    ...
    {
      date: "2026-07-10",
      title: "V2.1.7 商圈兼容与福利登塔平衡",
      content:
        "修复部分玩家因旧前端缓存导致商圈懒加载资源打不开的问题，线上部署改为保留历史资源以兼容旧缓存；活动中心每日活跃、七日豪礼和连续满勤奖励整体加量，补足灵石、灵气、丹药与中期材料；登仙塔怪物曲线下调并加入境界软化，避免玩家提升境界后反而被塔层数值压制，同时登塔胜利修为与灵气奖励提高。",
    },
    {
      date: "2026-07-10",
    ...
    },
    {
      ...
      content:
        "NPC页新增村庄回响/人情反馈，把全村平均好感、婚后天数、子女学识羁绊、公会贡献转化为每周可领取的世界反馈奖励。玩家完成村庄请求、主动来信、婚姻陪伴、子女长期事件和公会贡献后，桃源村会给出声望文案、家族经验、好感与铜钱回响，让人物关系和世界状态开始记住玩家行为。",
    },
    {
      date: "2026-07-10",
    ...
    {
      date: "2026-07-10",
      title: "V2.1.3 市场宗门与人物行为深化",
      content:
        "新增玩家市场拍卖雏形、宗门经营机构、NPC主动来信、战斗流派Build与家族后代长期事件：修仙市集增加每日竞拍高阶材料，公会页新增外门执事堂/丹药供奉堂/巡山戒律堂，NPC页可回复村民来信，小屋新增子女远学/护院/族谱修订，战斗页加入剑修、雷法、玄甲、灵兽协战流派。继续把资源消耗、人物关系、战斗选择和家族传承串到已有入口。",
    },
    {
      date: "2026-07-10",
      title: "V2.1.2 世界剧情与赛季事件",
      content:
        "活动中心新增世界剧情与季节事件，把村庄、宗门、公会、家族、秘境、天气和节令串成长期世界线：凡界主线包含村雨妖影、宗门来信、家族灯火、登仙塔异鸣等阶段；季节事件根据春夏秋冬和雷雨天气动态出现，提供农事、人情、守夜、商路、镇妖等周期奖励。继续坚持不乱加新入口，而是在活动中心承载世界运转感。",
    },
    {
      date: "2026-07-09",
      title: "V2.1.1 世界系统深耕",
      content:
        "继续深耕既有玩法而非新增散入口：NPC页新增村庄人情请求，全村好感与基础产物形成循环；秘境/登仙塔新增战斗策略，爆发、守势、寻宝等路线影响战斗与掉落；公会周常加入协作工程，消耗灵骨、云纹丝、灵石换长期公会加成；技能页新增生活职业委托，让种田、钓鱼、采集、挖矿产物转化为每日技能经验；修仙市集显示七日行情风向；博物馆新增主题展览，按名望切换展陈并影响每日收入。",
    },
    {
      date: "2026-07-09",
      title: "V2.1.0 五段深耕合集",
    ...
    },
    {
      ...
      content:
        "知识库继续补充常见问题条目，并将页面名称从桃源乡知识库修正为《我从种田开始修仙》知识库。新增知识库使用方法、卡突破怎么办、仙界从哪里开始、仙界资源循环、仙缘命盘、混沌裂隙失败原因、仙界主线推进条件、更新记录查看等内容，方便玩家直接搜索问题。",
    },
    {
      date: "2026-07-09",
      title: "V2.0.2 更新记录与教程知识库",
      content:
        "修复前端更新记录显示不全：线上数据库 updateLogs 只保留了部分记录，改为同步后端默认完整更新记录并保留最新版本置顶；新手教程升级为可搜索知识库，支持按关键词搜索、分类筛选和热门问题快捷查询，玩家可直接搜索灵气不足、雷精、飞升、仙界、洞府、宗门、更新记录等内容。",
    },
    {
      date: "2026-07-09",
      title: "V2.0.1 仙界长线剧情",
    ...
    },
    {
      ...
      content:
        "仙界第二轮扩展：新增仙擂问道 PK，可挑战青冥剑仙、紫府雷将、广寒仙姬，按仙战力、仙术、洞天和连胜结算功德/仙玉/法则；新增仙职事务、洞天建设和凡界回响，让飞升后能处理天庭事务、建设观星台/功德池/法则碑，并赐福宗门、家族和灵田。",
    },
    {
      date: "2026-07-09",
    ...
    {
      date: "2026-07-08",
      title: "V1.7.3 瀚海商路与宗门远征",
      content:
        "瀚海新增商队路线与护送契约，门派新增宗门远征队，公会新增周常远征协作，把已有派遣/远征循环扩展到瀚海、门派和公会系统。",
    },
    {
      date: "2026-07-08",
    ...
    },
    {
      ...
      content:
        "宗门公共建设扩展为三大工程；农场新增灵田中后期经营目标；装备词条加入锁定、保底、套装与稀有图鉴；奇遇链升级为连续剧情、选择旗标与隐藏结局。",
    },
    {
      date: "2026-07-08",
      title: "V1.6.6 镇魔结算修复",
    ...
    },
    {
      ...
      title: "V1.6.4 全量留存玩法",
      content:
        "新增全服镇魔个人贡献奖励、宗门公共建设、装备词条洗练、闭关归来礼包、奇遇链与月度修行令，全部接入现有活动/门派/炼器入口与存档。",
    },
    {
      date: "2026-07-07",
      title: "V1.6.3 周修行令",
      content:
        "活动中心新增周修行令，每7个游戏日重置一次，把秘境战斗、烹饪、博物馆捐赠、公会贡献、瀚海商誉、育种和钓鱼串成周目标，奖励灵石、灵气、资质经验和修仙材料。",
    },
    {
      date: "2026-07-07",
    ...
    },
    {
      ...
      content:
        "新增月华玉、日炎晶、玄铁、寒髓玉、凤羽、龙鳞、太虚尘、仙露、灵骨、妖丹、玉简、灵墨、云纹丝等修仙材料，并接入秘境/凶兽掉落、洞府折灵、背包来源说明和新手教程速查。",
    },
    {
      date: "2026-07-07",
      title: "V1.6.0 玩法补全目标",
    ...
    },
    {
      ...
      content:
        "修复排行榜战力与角色页战力不一致的问题：服务端战力公式补齐功法、宗门技能、修仙装备、符阵、本命法宝、灵兽羁绊、武器/戒指与战斗技能等加成，避免部分玩家排行战力偏低。",
    },
    {
      date: "2026-07-07",
    ...
    },
    {
      ...
      title: "V1.4.3 修仙装备整合",
      content:
        "修仙装备栏改为更直观的灵剑、法衣、云靴、护符，和农场/矿洞装备区分；旧护道装备等级自动迁移，并为后续炼器页贯通打底。",
    },
    {
      date: "2026-07-06",
      title: "V1.4.2 渡劫准备与修仙装备",
      content:
        "角色页新增独立修仙装备：灵剑、法衣、云靴、护符，可消耗秘境材料与灵石淬炼，提升战力和渡劫稳定；渡劫成功公告升级为全服滚动弹窗，文字完整滚完后自动消失。",
    },
    {
      date: "2026-07-06",
      title: "V1.4.1 炼丹品相",
    ...
    },
    {
      ...
      title: "V1.4.0 秘境抉择",
      content:
        "秘境探索和挑战凶兽胜利后有概率触发秘境抉择：古修遗府、灵脉泉眼、妖兽巢穴提供二选一奖励，让玩家按突破、材料、灵植或稳妥恢复目标做取舍。",
    },
    {
      date: "2026-07-06",
      title: "V1.3.9 宗门差异深化",
      content:
        "三宗特性接入实战循环：剑宗提升战斗攻击，丹宗提高额外成丹与灵植灵气收益，符宗提升防御/气血并强化闭关净化心魔；宗门页新增实战加成展示。",
    },
    {
      date: "2026-07-06",
      title: "V1.3.8 多材料订单与秘境灵种",
      content:
        "特殊订单支持多材料交付，护魂丹双材令现在需要冰魄雪莲+紫韵灵芝；任务详情显示多材料与背包进度；秘境奇遇新增灵种遗藏/灵芝孢子，可掉落高阶灵植种子。",
    },
    {
      date: "2026-07-06",
      title: "V1.3.7 秘境纵深与灵植炼丹闭环",
      content:
        "秘境稀有事件（8种奇遇：灵脉发现、古修遗府、心魔净化、野生灵药、稀有灵药、灵宝感应、深层灵脉、先贤启示）| 高阶灵植冰魄雪莲与紫韵灵芝 | 灵植丹方3种（雪莲清心丹、灵芝培元丹、冰魄护魂丹，按境界解锁）| 高阶宗门灵植订单",
    },
    {
      date: "2026-07-06",
    ...
    },
    {
      ...
      content:
        "继续深化宗门系统：三宗新增专属委派，剑宗可剑冢试剑获得星陨铁与灵石，丹宗可丹房看炉消耗凝露草换灵植种子，符宗可符阵巡检消耗灵石换魂晶与木灵珠；宗门技能、职位、功勋更明确接入战力估算，让三宗定位更有差异。",
    },
    {
      date: "2026-07-06",
      title: "V1.3.1 宗门纵深第一期",
      content:
        "宗门系统从单纯选择门派和升级技能，扩展为职位、每日宗门日课、贡献、功勋和宗门宝库循环；新增外门/内门/亲传/执事/长老候补晋升，日课可获得贡献功勋，贡献可升级技能或兑换灵石、灵植种子、秘境材料。",
    },
    {
      date: "2026-07-06",
      title: "V1.3.0 玩法内容纵深第一期",
      content:
        "更新方向从新增入口转向深耕已有玩法：特殊订单新增宗门灵植订单，要求提交蕴灵稻、凝露草、朱果、雪莲等灵植，奖励灵石、种子与秘境材料；特殊订单提交时会实际扣除目标物品，让种田、订单、修仙、秘境材料形成更完整循环。",
    },
    {
      date: "2026-07-06",
    ...
    },
    {
      ...
      content:
        "修复修仙之途战斗胜利未计入修行志怪物击杀的问题；将初战凶兽任务改名为初战妖兽，并明确引导到地图 → 修仙之途 → 秘境，可通过红尘历练、秘境探索或登仙塔低层完成。",
    },
    {
      date: "2026-07-06",
    ...
    },
    {
      ...
      content:
        "修复修仙市集入口只停留在普通商圈的问题，现在进入后会打开独立修仙市集，直接展示灵石、丹药、纳物符、乾坤袋与功法秘籍。",
    },
    {
      date: "2026-07-06",
      title: "V1.1.3 修仙市集入口",
    ...
    },
    {
      ...
      title: "V1.1.2 限时活动入口",
      content:
        "新增独立「限时活动」页面和地图按钮，妖潮来袭可查看进度、前往秘境讨伐并直接领取活动奖励，活动说明同步写入新手教程。",
    },
    {
      date: "2026-07-06",
    ...
    },
    {
      ...
      title: "V1.1 七线补全",
      content:
        "修行志新增七条长期目标：修仙主线剧情、装备套装追求、深层秘境首通、仙盟互助、限时妖潮活动、下一步变强引导和回访福利，让玩家从新手到中后期都有明确追求与奖励反馈。",
    },
    {
      date: "2026-07-05",
    ...
    {
      date: "2026-07-03",
      title: "修仙 V0.5：秘境探索/炼器/门派/法宝",
      content: "⚔️秘境+🔨炼器+🏛️门派+🗡️法宝+🧘境界扩展",
    },
  ],
};
