...
const defaultConfig = {
  ...
  updateLogs: [
    ...
    {"date":"2026-07-11","title":"V2.8.6 裂隙轮值词缀","content":"仙界混沌裂隙新增裂隙轮值词缀：每日/每周混沌波动会切换虚潮涨落、坠星乱流、心魔低语、逆律回环、镇狱稳界等战场环境。词缀会影响首领战反噬、奖励倍率与推荐仙术，顺应用云体护身、星河落刃、曜阳真火、紫霄雷印等对应仙术可获得额外伤害和结算收益，让裂隙首领、猎榜、赛季功勋与功勋兑换形成更有变化的循环。"},
    {"date":"2026-07-11","title":"V2.8.5 裂隙功勋兑换","content":"仙界混沌裂隙新增功勋兑换·镇狱宝库：裂隙赛季功勋现在不仅用于段位和阶段奖励，还会形成可用功勋池，可兑换猎榜补给匣、遗珍碎片匣、裂隙法则核、镇狱稳界令。兑换可获得功德、仙玉、法则、仙器精魄、遗珍碎片和洞天稳定，每周限购，累计功勋不清零，只扣除可用功勋，让赛季追猎形成持续消耗与补短板闭环。"},
    {"date":"2026-07-11","title":"V2.8.4 裂隙赛季功勋","content":"仙界混沌裂隙新增裂隙赛季功勋：根据裂隙镇压次数、裂隙猎榜领取、首领遗珍炼化累计赛季功勋，并在裂隙页展示初临裂隙、裂隙初猎、猎榜入册、四象镇狱、裂隙猎尊等段位。新增四档赛季功勋奖励，达到功勋门槛后可领取功德、仙玉、法则、仙器精魄与遗珍碎片，让首领战不只停留在单次悬赏，而是形成可持续冲段与领奖的长期循环。"},
    {"date":"2026-07-11","title":"V2.8.3 裂隙猎榜与首领悬赏","content":"仙界混沌裂隙新增裂隙猎榜·首领悬赏：在裂隙页直接展示每日/每周追猎目标，击杀虚潮界鲸、坠星古傀、隙门心魔、逆律天眼或炼化首领遗珍都会推进猎榜进度。完成后可领取功德、仙玉、法则、仙器精魄与遗珍碎片，把首领击杀、弱点仙术、遗珍炼化和裂隙套装串成更稳定的周常追求闭环。"},
    {"date":"2026-07-11","title":"V2.8.2 首领遗珍与裂隙套装","content":"仙界裂隙新增首领遗珍系统：击杀四大具名首领后会获得对应遗珍碎片，裂隙页新增“首领遗珍·裂隙套装”面板，可消耗碎片、仙玉、法则与仙器精魄炼化归墟潮心、坠星傀核、净魔心灯、逆律天瞳。遗珍提供独立仙战力，Lv.2 两件/四件激活套装加成，并会降低深层裂隙法则反噬，让首领战、掉落、仙器精魄、法则和仙玉形成更明确的长期追求闭环。"},
