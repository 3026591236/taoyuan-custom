...
const defaultConfig = {
  ...
  updateLogs: [
    ...
    },
    {
      ...
      content:
        "知识库继续补充常见问题条目，并将页面名称从桃源乡知识库修正为《我从种田开始修仙》知识库，后续品牌过渡为《万象仙乡》知识库。新增知识库使用方法、卡突破怎么办、仙界从哪里开始、仙界资源循环、仙缘命盘、混沌裂隙失败原因、仙界主线推进条件、更新记录查看等内容，方便玩家直接搜索问题。",
    },
    {
      date: "2026-07-09",
