...
export const CULTIVATION_MARKET_ITEMS: ShopItemEntry[] = [
  ...
  { itemId: 'mystic_iron', name: '玄铁', price: 8800, description: '黑市限量灵矿，用于装备维护和高阶订单' },
  { itemId: 'cloud_silk', name: '云纹丝', price: 12800, description: '维护法衣/云靴的稀有灵丝' },
  { itemId: 'artifact_shard', name: '法宝碎片', price: 16800, description: '灵剑维护与本命法宝蕴养通用材料' },
  { itemId: 'thunder_essence', name: '雷精', price: 22000, description: '护符维护、雷法观想和渡劫准备材料' },
  { itemId: 'cultivation_boost_pill', name: '修为丹', price: 15000, description: '元婴期以下可服用，增长大量修为' },
  { itemId: 'minor_realm_pill', name: '境界丹', price: 58000, description: '元婴期以下可服用，直接提升一个小境界' },
  { itemId: 'ascension_boost_pill', name: '直升丹', price: 188000, description: '元婴期以下可服用，连升三重小境界' },
