...
export const useQuestStore = defineStore("quest", () => {
  ...
  const JOURNEY_TASKS: JourneyTaskDef[] = [
    ...
    },
    {
      ...
      type: "guide",
      title: "田间灵机",
      desc: "累计100点地脉感应，为启蒙灵田做准备。",
      metric: "earthPulse",
      target: 100,
      reward: { money: 420, attributeExp: { physique: 16, perception: 16 } },
    },
    {
    ...
    {
      id: "guide_field_tier_1",
      type: "guide",
      title: "黄阶灵田",
      desc: "把灵田提升到黄阶，开启更稳定的灵气产出。",
      metric: "fieldTier",
      target: 1,
      reward: { aura: 130, attributeExp: { physique: 20 } },
    },
    {
      id: "guide_realm_lianqi",
      type: "guide",
      title: "炼气入门",
      desc: "突破到炼气一层，迈出修仙第一步。",
      metric: "realmIndex",
      target: 1,
      reward: { aura: 180, attributeExp: { perception: 24 } },
    },
    {
      id: "guide_first_battle",
      type: "guide",
      title: "初战妖兽",
      desc: "前往地图 → 修仙之途 → 秘境，完成任意一次红尘历练、秘境探索或登仙塔战斗并获胜。",
      metric: "monsterKills",
      target: 1,
      reward: { money: 360, attributeExp: { strength: 18, agility: 18 } },
    },
    {
      id: "daily_harvest_5",
      type: "daily",
    ...
    },
    {
      ...
      type: "daily",
      title: "磨砺身手",
      desc: "累计击败3只怪物，提升战斗资质。",
      metric: "monsterKills",
      target: 3,
      reward: { money: 280, attributeExp: { strength: 16, agility: 16 } },
    },
    {
      id: "daily_fish_2",
      type: "daily",
      title: "今日垂钓",
      desc: "钓到2条鱼，补上轻松休闲的每日收益。",
      metric: "fishCaught",
      target: 2,
      reward: { money: 300, attributeExp: { agility: 14, perception: 10 } },
    },
    {
      id: "daily_mine_floor",
      type: "daily",
    ...
    },
    {
      ...
      type: "daily",
      title: "今日开灶",
      desc: "制作1道料理，让烹饪成为每日强化的一环。",
      metric: "recipesCooked",
      target: 1,
      reward: { money: 240, attributeExp: { perception: 14, physique: 10 } },
    },
    {
      id: "daily_forage_3",
      type: "daily",
    ...
    },
    {
      ...
      reward: {
        money: 300,
        aura: 60,
        attributeExp: { strength: 14, perception: 10 },
      },
    },
    {
      id: "seven_day_1",
    ...
    },
    {
      ...
      day: 3,
      title: "第三日：灵田启蒙",
      desc: "完成灵田启蒙，普通农事开始转化灵气。",
      metric: "cultivationUnlocked",
      target: 1,
      reward: { aura: 160, attributeExp: { perception: 28 } },
    },
    {
      id: "seven_day_4",
      type: "sevenDay",
      day: 4,
      title: "第四日：炼气修行",
      desc: "突破到炼气一层，形成第一段修仙目标。",
      metric: "realmIndex",
      target: 1,
      reward: { aura: 190, attributeExp: { physique: 26 } },
    },
    {
      id: "seven_day_5",
      type: "sevenDay",
      ...
      metric: "monsterKills",
      target: 5,
      reward: { money: 520, attributeExp: { strength: 30, agility: 30 } },
    },
    {
      id: "seven_day_6",
      type: "sevenDay",
      day: 6,
      title: "第六日：经营有成",
      desc: "累计赚取3000文，为灵田、法宝和洞府准备资源。",
      metric: "moneyEarned",
      target: 3000,
      reward: { money: 720, attributeExp: { perception: 28 } },
    },
    {
      id: "seven_day_7",
      type: "sevenDay",
      day: 7,
      title: "第七日：小有所成",
      desc: "角色资质总评达到24，感受日常行为带来的角色成长。",
      metric: "attributePower",
      target: 24,
      reward: {
        aura: 260,
        money: 900,
    ...
    {
      id: "v11_story_realm_2",
      type: "guide",
      title: "仙途主线：灵田异变",
      desc: "境界达到炼气二层，触发灵田异变剧情，明确继续修仙的主线目标。",
      metric: "realmIndex",
      target: 2,
      reward: { aura: 220, money: 500, attributeExp: { perception: 24 } },
    },
    {
      id: "v11_story_realm_10",
      type: "guide",
      title: "仙途主线：宗门来客",
      desc: "境界达到筑基，宗门执事来访，开启宗门因果与飞升线索。",
      metric: "realmIndex",
      target: 10,
      reward: {
        aura: 520,
    ...
    {
      id: "v11_equipment_set",
      type: "guide",
      title: "装备套装：青木雏形",
      desc: "功法总层数达到3层，形成第一套法宝/装备追求，后续可扩展套装词条。",
      metric: "manualLevels",
      target: 3,
      reward: {
        aura: 300,
        money: 900,
        attributeExp: { strength: 28, physique: 28 },
      },
    },
    {
      id: "v11_dungeon_floor_5",
      type: "guide",
      title: "深层秘境：五层首通",
      desc: "登仙塔达到5层，完成第一个深层秘境首通目标。",
      metric: "towerFloor",
      target: 5,
      reward: {
        aura: 360,
        money: 1000,
        attributeExp: { strength: 32, agility: 32 },
      },
    },
    {
      id: "v11_social_help",
      type: "guide",
      title: "玩家互动：仙盟互助",
      desc: "累计完成3个委托，解锁仙盟互助/寄售玩法的雏形奖励。",
      metric: "completedCommissions",
      target: 3,
      reward: { aura: 180, money: 888, attributeExp: { perception: 24 } },
    },
    {
      id: "v11_event_hunt",
      type: "guide",
      title: "限时活动：妖潮来袭",
      desc: "累计击败20只怪物，领取限时讨伐活动奖励。",
      metric: "monsterKills",
      target: 20,
      reward: {
        aura: 520,
        money: 1500,
        attributeExp: { strength: 40, agility: 40 },
      },
    },
    {
      id: "v11_return_bonus",
      type: "guide",
      title: "回访福利：仙缘再临",
      desc: "进入游戏即可领取一次V1.1回访福利，让老玩家回来就有收获。",
      metric: "cultivationUnlocked",
      target: 0,
      reward: {
        aura: 188,
    ...
    },
    {
      ...
      reward: {
        money: 1200,
        aura: 160,
        attributeExp: { physique: 36, perception: 20 },
      },
    },
    {
      id: "v12_fish_20",
    ...
    },
    {
      ...
      reward: {
        money: 900,
        aura: 120,
        attributeExp: { physique: 26, perception: 26 },
      },
    },
    {
      id: "v12_collect_40",
    ...
    },
    {
      ...
      reward: {
        money: 1000,
        aura: 160,
        attributeExp: { physique: 24, perception: 24 },
      },
    },
    {
      id: "v12_hybrid_1",
      type: "guide",
      title: "异种初现：发现杂交",
      desc: "发现1种杂交产物，鼓励尝试培育组合与收集。",
      metric: "hybridsDiscovered",
      target: 1,
      reward: {
        money: 1500,
        aura: 220,
        attributeExp: { perception: 36, agility: 18 },
      },
    },
    {
      id: "v12_manual_6",
      type: "guide",
      title: "功法精进：六层合参",
      desc: "功法总层数达到6层，形成修为、灵气、渡劫成功率的成长追求。",
      metric: "manualLevels",
      target: 6,
      reward: {
        aura: 520,
        money: 1600,
        attributeExp: { perception: 38, physique: 26 },
      },
    },
    {
      id: "v12_tower_10",
      type: "guide",
      title: "登仙试炼：十层留名",
      desc: "登仙塔达到10层，让战斗、装备、功法强度有更清晰的验证场。",
      metric: "towerFloor",
      target: 10,
      reward: {
        aura: 620,
        money: 2000,
        attributeExp: { strength: 44, agility: 36 },
      },
    },
    {
      ...
      reward: {
        aura: 280,
        money: 1800,
        attributeExp: { perception: 36, physique: 24 },
      },
    },
    {
      id: "v160_forage_25",
      ...
      reward: {
        money: 900,
        aura: 120,
        attributeExp: { agility: 24, perception: 34 },
      },
    },
    {
      id: "v160_museum_5",
    ...
    },
    {
      ...
      reward: {
        money: 1800,
        aura: 260,
        attributeExp: { strength: 42, agility: 28 },
      },
    },
    {
      ...
      reward: {
        money: 2200,
        aura: 320,
        attributeExp: { strength: 36, perception: 36 },
      },
    },
    {
      id: "v160_hanhai_unlock",
      type: "guide",
      title: "瀚海初航：解锁商路",
      desc: "解锁瀚海玩法，开启贸易、藏宝图和海市兑换。",
      metric: "hanhaiUnlocked",
      target: 1,
      reward: {
        money: 1600,
        aura: 180,
        attributeExp: { perception: 36, agility: 20 },
      },
    },
    {
      id: "v160_hanhai_trade_80",
      type: "guide",
      title: "瀚海贸易：八十商誉",
      desc: "通过瀚海寄售获得80点商誉，让多余物产进入更高阶兑换。",
      metric: "hanhaiTradePoints",
      target: 80,
      reward: { money: 2400, aura: 260, attributeExp: { perception: 44 } },
    },
    {
      id: "v160_breed_8",
      type: "guide",
      ...
      reward: {
        money: 1800,
        aura: 220,
        attributeExp: { physique: 32, perception: 38 },
      },
    },
    {
      id: "v160_hybrid_3",
      ...
      reward: {
        money: 3200,
        aura: 420,
        attributeExp: { perception: 62, agility: 24 },
      },
    },

    {
      id: "v208_gear_power_1000",
      type: "guide",
      title: "卡点指引：修仙装备成型",
      desc: "修仙装备总战力达到1000。若秘境/登塔打不动，去炼器页淬炼并维护灵韧。",
      metric: "daoGearPower",
      target: 1000,
      reward: {
        money: 2200,
        aura: 360,
        attributeExp: { strength: 40, physique: 30 },
      },
    },
    {
      id: "v208_cave_open",
      type: "guide",
      title: "卡点指引：开辟洞府",
      desc: "开辟洞府。若修行效率变慢，洞府静室、百草园与聚灵阵能补上长期收益。",
      metric: "caveTier",
      target: 1,
      reward: { money: 1800, aura: 420, attributeExp: { perception: 42 } },
    },
    {
      id: "v208_cave_stable",
      type: "guide",
      title: "卡点指引：灵脉维护",
      desc: "洞府灵脉稳定达到100。若收益下降，回洞府维护灵脉。",
      metric: "caveStability",
      target: 100,
      reward: {
        money: 1600,
        aura: 300,
    ...
    {
      id: "v210_family_legacy_3",
      type: "guide",
      title: "家族传承：三阶家业",
      desc: "家族传承达到3级。通过家族委托、子女互动和配偶协助沉淀长期收益。",
      metric: "familyLegacyLevel",
      target: 3,
      reward: {
        money: 2600,
        aura: 380,
        attributeExp: { perception: 36, physique: 28 },
      },
    },
  ];
  ...
  const getJourneyRawProgress = (metric: JourneyMetric): number => {
    ...
    switch (metric) {
      ...
      case "earthPulse":
        return cultivationStore.earthPulse;
      case "fieldTier":
        return cultivationStore.fieldTier;
      case "cultivationUnlocked":
        return cultivationStore.unlocked ? 1 : 0;
      case "realmIndex":
        return cultivationStore.realmIndex;
      case "moneyEarned":
      ...
      case "attributePower":
        return playerStore.attributePower;
      case "manualLevels":
        return Object.values(cultivationStore.manuals).reduce(
          (sum: number, level: unknown) => sum + (Number(level) || 0),
          0,
        );
      case "towerFloor":
        return useCombatStore().towerHighestFloor;
      case "fishCaught":
      ...
      case "guildGoalsCompleted":
        return useGuildStore().completedGoalCount;
      case "guildContribution":
        return useGuildStore().contributionPoints;
      case "hanhaiUnlocked":
        return useHanhaiStore().unlocked ? 1 : 0;
      case "hanhaiTradePoints":
        return useHanhaiStore().tradePoints;
      case "hanhaiTradeLevel":
        return useHanhaiStore().tradeShopLevel;
      case "daoGearPower":
        return cultivationStore.daoGearPower;
      case "caveTier":
        return cultivationStore.caveTier;
      case "caveStability":
        return cultivationStore.caveStability;
      case "familyLegacyLevel":
        return useNpcStore().familyLegacyLevel;
      default:
        return 0;
    }
  };
  ...
  const getJourneyProgress = (task: JourneyTaskDef): number => {
    ...
    const baseline =
      journeyDailyBaselines.value[task.metric] ??
      getJourneyRawProgress(task.metric);
  ...
  const nextJourneyTask = computed(() => {
    const tasks = journeyTasks.value;
    return (
      tasks.find((t) => t.done && !t.claimed) ||
      tasks.find((t) => t.type === "guide" && !t.claimed) ||
      tasks.find((t) => t.type === "daily" && !t.claimed) ||
      tasks.find((t) => t.type === "sevenDay" && !t.claimed) ||
      null
    );
  });

  const activeJourneyTasks = computed(() =>
    journeyTasks.value.filter((t) => !t.claimed).slice(0, 5),
  );

  const claimJourneyTask = (
    taskId: string,
    ...
    const gameStore = useGameStore();
    const moneyReward = task.reward.money
      ? Math.floor(
          task.reward.money * (gameStore.dailyFateType === "wealth" ? 1.15 : 1),
        )
      : 0;
    if (moneyReward) playerStore.earnMoney(moneyReward);
    if (task.reward.attributeExp)
      playerStore.addAttributeExpBatch(task.reward.attributeExp);
    if (task.reward.aura) {
      const cultivationStore = useCultivationStore();
    ...
    return {
      success: true,
      message: `【修行志】完成「${task.title}」，获得${rewardText || "奖励"}。`,
    };
  };
  ...
  const refreshQuestTargets = (quest: QuestInstance) => {
    if (quest.targets?.length) {
      quest.targets.forEach((t) => {
        t.collectedQuantity = Math.min(
          inventoryStore.getItemCount(t.itemId),
          t.quantity,
        );
      });
      quest.collectedQuantity = quest.targets.every(
        (t) => t.collectedQuantity >= t.quantity,
      )
    ...
    if (quest.type !== "delivery") {
      quest.collectedQuantity = Math.min(
        inventoryStore.getItemCount(quest.targetItemId),
        quest.targetQuantity,
      );
    }
  };

  const questTargetsReady = (
    quest: QuestInstance,
    ...
    if (quest.targets?.length) {
      for (const t of quest.targets) {
        ...
        if (effective < t.quantity)
          return {
            ok: false,
            message: `${t.name}收集进度不足（${effective}/${t.quantity}）。`,
          };
  ...
  const removeQuestTargets = (quest: QuestInstance) => {
    if (quest.targets?.length) {
      quest.targets.forEach((t) =>
        inventoryStore.removeItem(t.itemId, t.quantity),
      );
      return;
    }
  ...
  const acceptSpecialOrder = (): { success: boolean; message: string } => {
    if (!specialOrder.value)
      return { success: false, message: "没有可接取的特殊订单。" };
    if (activeQuests.value.length >= MAX_ACTIVE_QUESTS) {
      return {
        success: false,
        message: `最多同时接取${MAX_ACTIVE_QUESTS}个委托。`,
  ...
  const submitQuest = (
    ...
    if (quest.itemReward && quest.itemReward.length > 0) {
      const itemNames = quest.itemReward
  ...
  const onItemObtained = (itemId: string, quantity: number = 1) => {
    for (const quest of activeQuests.value) {
      ...
      if (quest.targets?.length) {
        quest.targets.forEach((t) => {
          if (t.itemId === itemId && t.collectedQuantity < t.quantity)
            t.collectedQuantity = Math.min(
              t.collectedQuantity + quantity,
              t.quantity,
            );
        });
        quest.collectedQuantity = quest.targets.every(
        ...
        quest.targetItemId === itemId &&
        quest.collectedQuantity < quest.targetQuantity
      ) {
        quest.collectedQuantity = Math.min(
          quest.collectedQuantity + quantity,
          quest.targetQuantity,
        );
      }
    }
    ...
    if (mainQuest.value?.accepted) {
      ...
      if (def) {
        for (let i = 0; i < def.objectives.length; i++) {
          ...
          if (
            obj.type === "deliverItem" &&
            obj.itemId === itemId &&
            !mainQuest.value.objectiveProgress[i]
          ) {
  ...
  const meetsLevel = (current: string, required: string): boolean => {
    return (
      LEVEL_ORDER.indexOf(current as (typeof LEVEL_ORDER)[number]) >=
      LEVEL_ORDER.indexOf(required as (typeof LEVEL_ORDER)[number])
    );
  };
  ...
  const evaluateObjective = (obj: MainQuestObjective): boolean => {
    ...
    switch (obj.type) {
      ...
      case "npcFriendship": {
        if (obj.npcId === "_any") {
          // 任意NPC达到指定好感
          return npcStore.npcStates.some((n) =>
            meetsLevel(
              npcStore.getFriendshipLevel(n.npcId),
              obj.friendshipLevel ?? "acquaintance",
            ),
          );
        }
  ...
  const initMainQuest = () => {
    ...
    const nextQuest =
      completedMainQuests.value.length === 0
        ? getFirstStoryQuest()
        : getNextStoryQuest(
            completedMainQuests.value[completedMainQuests.value.length - 1]!,
          );
  ...
  const acceptMainQuest = (): { success: boolean; message: string } => {
    ...
    // 接取时立即评估一次进度
    for (let i = 0; i < def.objectives.length; i++) {
      mainQuest.value.objectiveProgress[i] = evaluateObjective(
        def.objectives[i]!,
      );
    }
  ...
  const deserialize = (data: ReturnType<typeof serialize>) => {
    ...
    specialOrder.value =
      ((data as Record<string, unknown>)
        .specialOrder as QuestInstance | null) ?? null;
    mainQuest.value =
      ((data as Record<string, unknown>).mainQuest as MainQuestState | null) ??
      null;
    completedMainQuests.value =
      ((data as Record<string, unknown>).completedMainQuests as
        string[] | undefined) ?? [];
    journeyClaimed.value =
      ((data as Record<string, unknown>).journeyClaimed as
        string[] | undefined) ?? [];
    journeyDailyKey.value =
      ((data as Record<string, unknown>).journeyDailyKey as
        string | undefined) ?? "";
    journeyDailyBaselines.value =
