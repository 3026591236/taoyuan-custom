...
export const useAscensionStore = defineStore('ascension', () => {
  ...
  const clearImmortalBreakthroughFx = () => { immortalBreakthroughFx.value = null }
