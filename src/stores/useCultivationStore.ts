...
export type CaveSlotType =
  "alchemy" | "farm" | "meditation" | "herbgarden" | "spiritArray";
export type CultivationManualKey = "wood" | "thunder" | "void";
export type CultivationLessonId =
  "morning_breath" | "circulate_qi" | "thunder_contemplation";
export type CultivationPathId = "balanced" | "sword" | "alchemy" | "thunder";
export type DaoGearSlot = "sword" | "robe" | "boots" | "amulet";
export type DaoGearId =
  "immortal_sword" | "dharma_robe" | "cloud_boots" | "tribulation_amulet";
...
export const DAO_GEAR: DaoGearDef[] = [
  ...
  },
  {
    ...
    slot: "robe",
    name: "法衣",
    desc: "以魂晶和灵纹织就的护身法衣，稳固经脉、承受劫雷余波。",
    material: { itemId: "soul_crystal", name: "魂晶", quantity: 2 },
    spiritStoneCost: 10,
    powerPerLevel: 360,
    tribulationPerLevel: 0.01,
    maxLevel: 9,
  },
  {
    id: "cloud_boots",
  ...
  {
    id: "tribulation_amulet",
    slot: "amulet",
    name: "护符",
    desc: "以雷精书写避劫符纹的护身符，专门提高跨境渡劫稳定性。",
    material: { itemId: "thunder_essence", name: "雷精", quantity: 1 },
    spiritStoneCost: 16,
    powerPerLevel: 280,
    tribulationPerLevel: 0.018,
    maxLevel: 9,
  },
];
export const CULTIVATION_PATHS: CultivationPath[] = [
  {
    ...
    name: "清修",
    title: "清静守一",
    desc: "守中不偏，重视稳定吐纳与心境平衡。",
    focus: "稳修",
    bonusDesc: "打坐、闭关与压制心魔更稳定",
  },
  {
    id: "sword",
    name: "剑修",
    title: "剑心通明",
    desc: "以战养道，重视锋芒、战力和秘境历练。",
    focus: "战斗",
    bonusDesc: "战力、周天运转收益更高",
  },
  {
    id: "alchemy",
    name: "丹修",
    title: "丹火温神",
    desc: "以丹养命，重视灵植、炼丹与资源循环。",
    focus: "炼丹",
    bonusDesc: "炼化灵气与灵膳收益更高",
  },
  {
    id: "thunder",
    name: "雷修",
    title: "雷纹淬心",
    desc: "观雷淬体，重视渡劫准备与雷法心境。",
    focus: "渡劫",
    bonusDesc: "雷云观想、顿悟和渡劫稳定性更强",
  },
];
...
export const CULTIVATION_LESSONS: CultivationLesson[] = [
  {
    id: "morning_breath",
    name: "纳气晨课",
    desc: "顺着田间地脉吐纳一周，收益温和稳定，适合每日开局。",
    focus: "稳修",
    stamina: 8,
    reward: { aura: 45, cultivation: 90, mana: 18 },
  },
  {
    id: "circulate_qi",
    name: "周天运转",
    desc: "以灵气推动小周天，快速积累修为，但会消耗灵气与灵力。",
    focus: "冲修为",
    stamina: 10,
    auraCost: 80,
    manaCost: 20,
    reward: { cultivation: 260, mana: 8 },
  },
  {
    id: "thunder_contemplation",
    name: "雷云观想",
    desc: "观想劫云雷纹，淬炼心神，适合大境界突破前准备。",
    focus: "渡劫",
    stamina: 12,
    manaCost: 35,
    itemCost: { itemId: "thunder_essence", name: "雷精", quantity: 1 },
    reward: { cultivation: 160, yuanShenExp: 120 },
  },
];
export const CULTIVATION_MANUALS: Record<
  CultivationManualKey,
  {
    name: string;
    desc: string;
    maxLevel: number;
...
> = {
  ...
  void: {
    ...
    auraCost: 820,
    cultivationCost: 520,
    effects: "灵力、元神与突破稳定性提升",
  },
};

const ARTIFACT_NAMES: Record<ArtifactKey, string> = {
  glimmerHoe: "流光锄",
  spiritKettle: "引灵壶",
  spiritRain: "灵雨诀",
};
...
export const REALM_EVENTS: RealmEvent[] = [
  ...
  },
  {
    id: "spirit_herb",
    name: "野生灵药",
    desc: "路边发现一株野生灵药，小心采下。",
    chance: 0.15,
    minRealm: 0,
    effect: "item",
    value: 0,
    itemReward: { itemId: "dew_grass", name: "凝露草", qty: 2 },
  },
  {
    id: "rare_spirit_herb",
    name: "稀有灵药",
    desc: "石缝中隐现一株珍稀灵药，灵气四溢。",
    chance: 0.07,
    minRealm: 12,
    effect: "item",
    value: 0,
    itemReward: { itemId: "ice_soul_lotus", name: "冰魄雪莲", qty: 1 },
  },
  {
    id: "rare_seed_cache",
    name: "灵种遗藏",
  ...
  },
  {
    id: "ganoderma_spore",
    name: "灵芝孢子",
    desc: "秘境枯木间飘出紫色孢子，正可带回灵田培育。",
    chance: 0.05,
    minRealm: 14,
    effect: "item",
    value: 0,
    itemReward: {
      itemId: "seed_purple_ganoderma",
      name: "紫韵灵芝孢子",
      qty: 1,
    },
  },
  {
    id: "treasure_hint",
    name: "灵宝感应",
    desc: "你感应到远处有灵宝的气息，顿悟了一丝天道。",
    chance: 0.05,
    minRealm: 16,
    effect: "artifact_hint",
    value: 5,
  },
  {
    id: "spirit_vein_deep",
    name: "深层灵脉",
    desc: "秘境深处涌出浓郁灵气，修为大进。",
    chance: 0.05,
    minRealm: 18,
    effect: "aura",
    value: 500,
...
export const TALISMAN_DATA: TalismanDef[] = [
  ...
  },
  {
    id: "thunder_talisman",
    name: "雷符",
    effect: "雷法攻势，兼具战力与渡劫感应。",
    power: 260,
    tribulation: 0.002,
  },
];
const isTalismanId = (id: string): id is TalismanId =>
  TALISMAN_DATA.some((t) => t.id === id);

export const BEAST_DATA: Record<
  BeastId,
  {
    name: string;
    emoji: string;
...
> = {
  ...
  crane: {
    ...
    emoji: "🦢",
    desc: "清雅高洁，修行时心境通透",
    bonusType: "meditation",
    bonusDesc: "打坐修为+40%",
    feedCrop: "spirit_rice",
    feedQty: 5,
  },
  phoenix: {
    name: "青鸾",
    ...
    bonusType: "alchemy",
    bonusDesc: "炼丹品质提升",
    feedCrop: "vermilion_fruit",
    feedQty: 3,
  },
};

export const CAVE_SLOT_DATA: Record<
  CaveSlotType,
...
const ALCHEMY_RECIPES = {
  mana_recovery_pill: {
    name: "回灵丹",
    materials: [{ itemId: "dew_grass", quantity: 2 }],
    aura: 20,
    mana: 0,
    output: 1,
  },
  qi_gathering_pill: {
    name: "聚气丹",
    materials: [
      { itemId: "spirit_rice", quantity: 3 },
      { itemId: "dew_grass", quantity: 1 },
    ],
    aura: 60,
    mana: 10,
    output: 1,
  ...
  foundation_pill: {
    name: "筑基丹",
    materials: [
      { itemId: "vermilion_fruit", quantity: 2 },
      { itemId: "dew_grass", quantity: 3 },
      { itemId: "spirit_rice", quantity: 5 },
    ],
    aura: 360,
    mana: 40,
    output: 1,
  ...
  lianjing_pill: {
    name: "炼精丹",
    materials: [
      { itemId: "chuanxiong", quantity: 30 },
      { itemId: "baizhi", quantity: 30 },
      { itemId: "suoyang", quantity: 30 },
    ],
    aura: 300,
    mana: 25,
    output: 1,
  ...
  huaqi_pill: {
    name: "化气丹",
    materials: [
      { itemId: "chonglou", quantity: 40 },
      { itemId: "chenxiang", quantity: 40 },
      { itemId: "peilan", quantity: 40 },
    ],
    aura: 400,
    mana: 35,
    output: 1,
  ...
  lianqi_pill: {
    name: "炼气丹",
    materials: [
      { itemId: "chuanxiong", quantity: 50 },
      { itemId: "yuzhu", quantity: 50 },
      { itemId: "chishao", quantity: 50 },
      { itemId: "chonglou", quantity: 50 },
      { itemId: "shenqu", quantity: 50 },
    ],
    aura: 500,
    mana: 50,
    output: 1,
  ...
  huashen_pill: {
    name: "化神丹",
    materials: [
      { itemId: "chuanxiong", quantity: 60 },
      { itemId: "chonglou", quantity: 60 },
      { itemId: "baizhi", quantity: 60 },
      { itemId: "chishao", quantity: 60 },
      { itemId: "suoyang", quantity: 60 },
    ],
    aura: 600,
    mana: 60,
    output: 1,
  ...
  lianshen_pill: {
    name: "炼神丹",
    materials: [
      { itemId: "yuzhu", quantity: 70 },
      { itemId: "chishao", quantity: 70 },
      { itemId: "chonglou", quantity: 70 },
      { itemId: "suoyang", quantity: 70 },
      { itemId: "peilan", quantity: 70 },
    ],
    aura: 700,
    mana: 70,
    output: 1,
  ...
  life_extension_pill: {
    name: "延寿丹",
    materials: [
      { itemId: "longkui", quantity: 3 },
      { itemId: "shenqu", quantity: 5 },
      { itemId: "ziwan", quantity: 5 },
    ],
    aura: 500,
    mana: 80,
    output: 1,
  ...
  marrow_wash_pill: {
    name: "洗髓丹",
    materials: [
      { itemId: "longkui", quantity: 5 },
      { itemId: "chishao", quantity: 10 },
      { itemId: "chenxiang", quantity: 10 },
      { itemId: "ziwan", quantity: 10 },
    ],
    aura: 800,
    mana: 100,
    output: 1,
  ...
  returning_void_pill: {
    name: "还虚丹",
    materials: [
      { itemId: "chuanxiong", quantity: 20 },
      { itemId: "yuzhu", quantity: 20 },
      { itemId: "chonglou", quantity: 20 },
      { itemId: "chenxiang", quantity: 20 },
    ],
    aura: 450,
    mana: 45,
    output: 1,
  ...
  refining_void_pill: {
    ...
    materials: [
      { itemId: "baizhi", quantity: 30 },
      { itemId: "chishao", quantity: 30 },
      { itemId: "ziwan", quantity: 30 },
      { itemId: "peilan", quantity: 30 },
      { itemId: "shenqu", quantity: 30 },
    ],
    aura: 650,
    mana: 65,
    output: 1,
  ...
  merge_way_pill: {
    ...
    materials: [
      { itemId: "longkui", quantity: 3 },
      { itemId: "ziwan", quantity: 15 },
      { itemId: "peilan", quantity: 15 },
      { itemId: "shenqu", quantity: 15 },
    ],
    aura: 1000,
    mana: 100,
    output: 1,
  ...
  nirvana_soul_pill: {
    name: "涅魂丹",
    materials: [
      { itemId: "thunder_essence", quantity: 2 },
      { itemId: "longkui", quantity: 2 },
      { itemId: "shenqu", quantity: 12 },
      { itemId: "soul_crystal", quantity: 3 },
    ],
    aura: 1200,
    mana: 140,
    output: 1,
  ...
  spirit_mending_pill: {
    name: "补灵丹",
    materials: [
      { itemId: "baizhi", quantity: 25 },
      { itemId: "yuzhu", quantity: 25 },
      { itemId: "ziwan", quantity: 25 },
    ],
    aura: 550,
    mana: 55,
    output: 1,
  ...
  rebirth_pill: {
    name: "轮回丹",
    materials: [
      { itemId: "longkui", quantity: 10 },
      { itemId: "shenqu", quantity: 15 },
      { itemId: "ziwan", quantity: 15 },
      { itemId: "suoyang", quantity: 10 },
    ],
    aura: 3000,
    mana: 200,
    output: 1,
  ...
  snow_lotus_pill: {
    name: "雪莲清心丹",
    materials: [
      { itemId: "ice_soul_lotus", quantity: 3 },
      { itemId: "dew_grass", quantity: 2 },
    ],
    aura: 200,
    mana: 30,
    output: 1,
  ...
  ganoderma_pill: {
    name: "灵芝培元丹",
    materials: [
      { itemId: "purple_ganoderma", quantity: 3 },
      { itemId: "spirit_rice", quantity: 5 },
      { itemId: "dew_grass", quantity: 2 },
    ],
    aura: 400,
  ...
  ice_soul_pill: {
    name: "冰魄护魂丹",
    materials: [
      { itemId: "ice_soul_lotus", quantity: 5 },
      { itemId: "purple_ganoderma", quantity: 3 },
      { itemId: "soul_crystal", quantity: 2 },
    ],
    aura: 800,
...
type MarketPillId =
  "cultivation_boost_pill" | "minor_realm_pill" | "ascension_boost_pill";
...
export interface RebirthMaterialCost {
  itemId: string;
  name: string;
  quantity: number;
}
...
export const SPIRIT_STONE_EXCHANGES: SpiritStoneExchangeRecipe[] = [
  ...
  {
    id: "true_spirit_record",
    name: "真灵秘录折灵",
    itemId: "true_spirit_record",
    itemName: "真灵秘录",
    quantity: 1,
    spiritStones: 16,
    desc: "二转后会用于轮回凭证，前期多余时才建议折灵。",
  },
  {
    id: "reincarnation_dust",
    name: "轮回尘折灵",
    itemId: "reincarnation_dust",
    itemName: "轮回尘",
    quantity: 1,
    spiritStones: 18,
    desc: "二转后会用于稳定轮回，前期多余时才建议折灵。",
  },
  {
    id: "lingyun_jade",
    name: "灵蕴玉折灵",
    ...
    quantity: 1,
    spiritStones: 20,
    desc: "高转轮回材料价值较高，慎重折换。",
  },
  {
    id: "moonlight_jade",
    name: "月华玉折灵",
    itemId: "moonlight_jade",
    itemName: "月华玉",
    quantity: 1,
    spiritStones: 9,
    desc: "月华灵玉可折成稳定灵石。",
  ...
  },
  {
    ...
    quantity: 1,
    spiritStones: 11,
    desc: "寒髓玉适合护符/丹药，也能换取灵石。",
  },
  {
    id: "phoenix_plume",
    name: "凤羽折灵",
    itemId: "phoenix_plume",
    itemName: "凤羽",
    quantity: 1,
    spiritStones: 14,
    desc: "赤金凤羽灵性充足，建议富余后再折灵。",
  },
  {
    id: "dragon_scale",
    name: "龙鳞折灵",
  ...
  },
  {
    ...
    quantity: 1,
    spiritStones: 16,
    desc: "妖丹可用于炼器或丹引，富余时折灵。",
  },
];

const REAL_DAILY_ACCUMULATION_CAP = 7;
const MS_PER_DAY = 24 * 60 * 60 * 1000;
const REALM_MAJOR_ORDER = [
  "凡人",
  "炼气",
  "筑基",
  "金丹",
...
const realmMajor = (name: string) =>
  REALM_MAJOR_ORDER.find((key) => name.startsWith(key)) ?? name;

export type SpiritMealId =
  | "plain_spirit_porridge"
  | "dew_rice_soup"
  | "vermilion_elixir_soup"
  | "three_treasure_spirit_meal";
...
export const SPIRIT_MEAL_RECIPES: SpiritMealRecipe[] = [
  {
    id: "plain_spirit_porridge",
    name: "灵谷粥",
    desc: "以普通稻米引气入体，适合刚启蒙后的每日温养。",
    materials: [{ itemId: "rice", quantity: 3, name: "水稻" }],
    stamina: 3,
    aura: 18,
    cultivation: 35,
    mana: 8,
  ...
  },
  {
    id: "dew_rice_soup",
    name: "凝露灵粥",
    desc: "蕴灵稻配凝露草，灵气温和，能稳定增长修为。",
    materials: [
      { itemId: "spirit_rice", quantity: 2, name: "蕴灵稻" },
      { itemId: "dew_grass", quantity: 1, name: "凝露草" },
    ],
    stamina: 5,
    aura: 55,
    cultivation: 120,
  ...
  {
    id: "vermilion_elixir_soup",
    name: "朱果丹羹",
    desc: "朱果入羹，药力绵长，适合突破前积蓄底蕴。",
    materials: [
      { itemId: "vermilion_fruit", quantity: 1, name: "朱果" },
      { itemId: "dew_grass", quantity: 2, name: "凝露草" },
    ],
    stamina: 8,
    aura: 120,
    cultivation: 260,
  ...
  {
    id: "three_treasure_spirit_meal",
    name: "三宝灵膳",
    desc: "灵稻、凝露草、朱果三味合一，每日只宜少食。",
    materials: [
      { itemId: "spirit_rice", quantity: 5, name: "蕴灵稻" },
      { itemId: "dew_grass", quantity: 3, name: "凝露草" },
      { itemId: "vermilion_fruit", quantity: 2, name: "朱果" },
    ],
    stamina: 12,
    aura: 260,
    cultivation: 620,
...
export const REALMS = [
  ...
  },
  {
    ...
    maxCultivation: 2600,
    maxMana: 195,
    breakthroughCost: 750,
  },
  {
    name: "炼气七层",
    maxCultivation: 3700,
    maxMana: 240,
    breakthroughCost: 1100,
  },
  {
    name: "炼气八层",
    maxCultivation: 5200,
    maxMana: 290,
    breakthroughCost: 1600,
  },
  {
    name: "炼气九层",
    maxCultivation: 7200,
    maxMana: 350,
    breakthroughCost: 2400,
  },
  {
    name: "筑基初期",
    maxCultivation: 11000,
    maxMana: 460,
    breakthroughCost: 3500,
  },
  {
    name: "筑基中期",
    maxCultivation: 16000,
    maxMana: 580,
    breakthroughCost: 5000,
  },
  {
    name: "筑基后期",
    maxCultivation: 24000,
    maxMana: 720,
    breakthroughCost: 7500,
  },
  {
    name: "金丹初期",
    maxCultivation: 40000,
    maxMana: 1000,
    breakthroughCost: 12000,
  },
  {
    name: "金丹中期",
    maxCultivation: 65000,
    maxMana: 1400,
    breakthroughCost: 18000,
  },
  {
    name: "金丹后期",
    maxCultivation: 100000,
    maxMana: 2000,
    breakthroughCost: 28000,
  },
  {
    name: "元婴初期",
    maxCultivation: 160000,
    maxMana: 2800,
    breakthroughCost: 42000,
  },
  {
    name: "元婴中期",
    maxCultivation: 250000,
    maxMana: 3800,
    breakthroughCost: 60000,
  },
  {
    name: "元婴后期",
    maxCultivation: 400000,
    maxMana: 5200,
    breakthroughCost: 85000,
  },
  {
    name: "化神初期",
    maxCultivation: 650000,
    maxMana: 7200,
    breakthroughCost: 120000,
  },
  {
    name: "化神中期",
    maxCultivation: 1000000,
    maxMana: 10000,
    breakthroughCost: 170000,
  },
  {
    name: "化神后期",
    maxCultivation: 1600000,
    maxMana: 14000,
    breakthroughCost: 240000,
  },
  {
    name: "渡劫初期",
    maxCultivation: 2600000,
    maxMana: 20000,
    breakthroughCost: 340000,
  },
  {
    name: "渡劫中期",
    maxCultivation: 4200000,
    maxMana: 28000,
    breakthroughCost: 480000,
  },
  {
    name: "渡劫后期",
    maxCultivation: 6800000,
    maxMana: 40000,
    breakthroughCost: 680000,
  },
  {
    name: "大乘初期",
    maxCultivation: 11000000,
    maxMana: 58000,
    breakthroughCost: 960000,
  },
  {
    name: "大乘中期",
    maxCultivation: 18000000,
    maxMana: 82000,
    breakthroughCost: 1350000,
  },
  {
    name: "大乘后期",
    maxCultivation: 30000000,
    maxMana: 120000,
    breakthroughCost: 1900000,
  },
];
...
export const getSpiritCropAura = (cropId: string): number =>
  SPIRIT_CROP_AURA[cropId] ?? 0;
...
export const useCultivationStore = defineStore("cultivation", () => {
  ...
  const daoGearDurability = ref<Record<DaoGearId, number>>({
    immortal_sword: 100,
    dharma_robe: 100,
    cloud_boots: 100,
  ...
  const spiritMealLastDaily = ref<Record<SpiritMealId, string>>({
    plain_spirit_porridge: "",
    dew_rice_soup: "",
    vermilion_elixir_soup: "",
    three_treasure_spirit_meal: "",
  });
  const artifacts = ref<Record<ArtifactKey, boolean>>({
    glimmerHoe: false,
    spiritKettle: false,
    spiritRain: false,
  });
  ...
  const beastExpedition = ref<{
    type: "guard" | "expedition";
    daysLeft: number;
  } | null>(null);
  ...
  const destinedArtifactDailyKey = ref("");
  const destinedArtifactDailyCount = ref(0);
  ...
  const talismanRechargeRate = computed(
    () => 1 + Math.floor(realmIndex.value / 3),
  );
  const talismanEffectMultiplier = computed(
    () =>
      1 +
      (sect.value === "talisman" ? 0.25 : 0) +
      (cultivationPath.value === "thunder" ? 0.1 : 0),
  );
  const talismanPower = computed(() => {
    const raw =
      TALISMAN_DATA.reduce(
  ...
  const talismanTribulationBonus = computed(() => {
    const raw =
      TALISMAN_DATA.reduce(
        (sum, t) => sum + (talismans.value[t.id] || 0) * t.tribulation,
        0,
      ) * talismanEffectMultiplier.value;
  ...
  const sectCombatAttackBonusRate = computed(() =>
    sect.value === "sword"
      ? Math.min(
          0.35,
          0.04 * sectSkillTotal.value + 0.025 * (sectRank.value || 0),
        )
      : 0,
  );
  const sectCombatDefenseBonusRate = computed(() =>
    sect.value === "talisman"
      ? Math.min(
          0.3,
          0.035 * sectSkillTotal.value + 0.025 * (sectRank.value || 0),
        )
      : 0,
  );
  const sectMaxHpBonusRate = computed(() =>
    sect.value === "talisman"
      ? Math.min(
          0.24,
          0.025 * sectSkillTotal.value + 0.02 * (sectRank.value || 0),
        )
      : 0,
  );
  const sectAlchemyExtraOutputChance = computed(() =>
    sect.value === "alchemy"
      ? Math.min(
          0.35,
          0.04 * sectSkillTotal.value + 0.03 * (sectRank.value || 0),
        )
      : 0,
  );
  const sectSpiritCropAuraBonusRate = computed(() =>
    sect.value === "alchemy"
      ? Math.min(
          0.3,
          0.035 * sectSkillTotal.value + 0.02 * (sectRank.value || 0),
        )
      : 0,
  );
  const sectDemonClearBonus = computed(() =>
    sect.value === "talisman"
      ? Math.min(10, sectSkillTotal.value + (sectRank.value || 0) * 2)
      : 0,
  );
  const manuals = ref<Record<CultivationManualKey, number>>({
    wood: 0,
    thunder: 0,
    void: 0,
  });
  ...
  const currentCultivationPath = computed(
    () =>
      CULTIVATION_PATHS.find((p) => p.id === cultivationPath.value) ??
      CULTIVATION_PATHS[0]!,
  );
  ...
  const combatPower = computed(() => {
    ...
    for (const v of Object.values(artifactMap)) {
      ...
      artifactPower += Math.floor(
        Number(v.atk || 0) * 12 +
          Number(v.def || 0) * 10 +
          Number(v.aura || 0) * 4 +
          Number(v.cultivation || 0) * 6,
      );
    }
    const oldArtifactPower =
      ["glimmerHoe", "spiritKettle", "spiritRain"].filter(
        (k) => artifactMap[k] === true,
      ).length * 80;
    const weaponPower =
      Math.max(0, Number(inventory.getWeaponAttack?.() || 0)) * 16;
    const ringPower = Math.floor(
      (inventory.getRingEffectValue?.("attack_bonus") || 0) * 120 +
        (inventory.getRingEffectValue?.("defense_bonus") || 0) * 100 +
        (inventory.getRingEffectValue?.("max_hp_bonus") || 0) * 3,
    );
    const majorStageBonus = Math.floor(
      Math.pow(Math.floor(realmIndex.value / 3), 2) * 1200,
    );
    const realmPower =
      realmIndex.value * 3500 + majorStageBonus + rebirthCount.value * 50000;
    // V2.5.2：战力只吃境界稳定底蕴，不再直接吃“当前修为/当前灵气/当前灵力”。
    // 突破会清空修为并消耗灵气，如果把这些临时资源当作战力，会出现成功突破反而掉战力的反直觉体验。
    const realmFoundationPower = Math.floor(
      maxCultivation.value * 1.05 + maxMana.value * 24,
    );
    const auraFoundationPower = Math.floor(
      Math.log10(Math.max(1, aura.value) + 1) * 180,
    );
    const cultivationPower = realmFoundationPower + auraFoundationPower;
    const bodyPower = Math.floor(
      player.attributePower * 6 +
        player.getMaxHp() * 1.5 +
        skills.combatLevel * 180,
    );
    const manualPower =
      manuals.value.wood * 180 +
      manuals.value.thunder * 320 +
      manuals.value.void * 420;
    const sectSkillPower = sectSkills.value.reduce(
      (sum, lv, idx) => sum + lv * (220 + idx * 120),
      0,
    );
    const sectIdentityPower =
      sect.value === "sword"
        ? sectSkillPower * 0.35
        : sect.value === "talisman"
          ? sectSkillPower * 0.18 + (sectRank.value || 0) * 260
          : sect.value === "alchemy"
            ? (sectRank.value || 0) * 180
            : 0;
    const pathPower =
      cultivationPath.value === "sword"
        ? manuals.value.thunder * 180 + realmIndex.value * 55
        : cultivationPath.value === "thunder"
          ? insight.value * 10 + manuals.value.thunder * 150
          : cultivationPath.value === "alchemy"
            ? fieldTier.value * 160 + manuals.value.wood * 120
            : Math.max(0, 100 - heartDemon.value) * 4;
    const systemPower =
      fieldTier.value * 120 +
      caveTier.value * 180 +
      ...
      talismanPower.value +
      beastBond.value * 12 +
      (beastExpedition.value?.type === "guard" ? beastLevel.value * 180 : 0) +
      sectContribution.value * 0.2 +
      (sectMerit.value || 0) * 0.6 +
      sectSkillPower +
      sectIdentityPower +
      pathPower +
      manualPower;
  ...
  const maxMana = computed(
    () => realm.value.maxMana + fieldTier.value * 10 + yuanShenLevel.value * 2,
  );
  const fieldTierName = computed(
    () => FIELD_TIERS[fieldTier.value] ?? FIELD_TIERS[0]!,
  );
  const spiritRootName = computed(() => SPIRIT_ROOT_NAMES[spiritRoot.value]);
  const breakthroughAuraCost = computed(() =>
    Math.max(0, realm.value.breakthroughCost - foundationPillBlessing.value),
  );
  const breakthroughCultivationMissing = computed(() =>
    Math.max(0, maxCultivation.value - cultivation.value),
  );
  ...
  const breakthroughRequirementText = computed(() => {
    ...
    if (breakthroughAuraMissing.value > 0)
      parts.push(`灵气还差${Math.ceil(breakthroughAuraMissing.value)}`);
    return parts.length ? parts.join("，") : "条件已满足";
  });
  const nextRealm = computed(
    () =>
      REALMS[Math.min(realmIndex.value + 1, REALMS.length - 1)] ?? realm.value,
  );
  const isMajorBreakthrough = computed(
    () => realmMajor(nextRealm.value.name) !== realmMajor(realm.value.name),
  );
  const tribulationSuccessRate = computed(() => {
    if (!isMajorBreakthrough.value) return 1;
    const base = 0.72;
    const realmPenalty = Math.min(
      0.18,
      Math.floor(realmIndex.value / 5) * 0.03,
    );
  ...
  const tribulationSuccessPercent = computed(() =>
    Math.round(tribulationSuccessRate.value * 100),
  );
  ...
  const caveTierData = computed(
    () => CAVE_TIERS[caveTier.value] ?? CAVE_TIERS[0]!,
  );
  const caveTierName = computed(() => caveTierData.value.name);
  const caveMaxSlots = computed(() => caveTierData.value.slots);
  const caveAuraRegen = computed(() =>
    Math.floor(caveTierData.value.auraRegen * caveStabilityRate.value),
  );
  const caveSlotNames = computed(() =>
    caveSlots.value.map((t) => CAVE_SLOT_DATA[t].name),
  );
  const hasCaveSlot = (type: CaveSlotType) => caveSlots.value.includes(type);
  const beastData = computed(() =>
    beast.value ? BEAST_DATA[beast.value] : null,
  );
  const beastName = computed(() => beastData.value?.name ?? "无");
  const beastEmoji = computed(() => beastData.value?.emoji ?? "");
  const daoGearDurabilityRate = (id: DaoGearId) =>
    Math.max(0.35, Math.min(1, (daoGearDurability.value[id] ?? 100) / 100));
  const daoGearPower = computed(() =>
    DAO_GEAR.reduce(
      (sum, gear) =>
        sum +
        Math.floor(
  ...
  const daoGearTribulationBonus = computed(() =>
    Math.min(
      0.16,
      DAO_GEAR.reduce(
        (sum, gear) =>
  ...
  const caveStabilityRate = computed(() =>
    caveTier.value <= 0
      ? 1
      : Math.max(0.45, Math.min(1.15, caveStability.value / 100)),
  );
  const spiritStoneRefineLimit = computed(
    () => 3 + (hasCaveSlot("spiritArray") ? 1 : 0),
  );
  const spiritStoneRefineCountToday = computed(() =>
    spiritStoneRefineDailyKey.value === todayKey()
      ? spiritStoneRefineDailyCount.value
      : 0,
  );
  const spiritStoneRefineRemaining = computed(() =>
    Math.max(
      0,
      spiritStoneRefineLimit.value - spiritStoneRefineCountToday.value,
    ),
  );
  const spiritStoneRefineCost = computed(
    () =>
      1000 +
      spiritStoneRefineCountToday.value * 500 +
      Math.floor(
        spiritStoneRefineCountToday.value *
          spiritStoneRefineCountToday.value *
          150,
      ),
  );
  const spiritStoneRefineAuraGain = computed(() => {
    ...
    const caveBonus =
      caveTier.value * 5 + (hasCaveSlot("spiritArray") ? 20 : 0);
  ...
  const canForgeDaoGear = (id: DaoGearId) => {
    ...
    const inventory = useInventoryStore();
    return (
      inventory.getItemCount(gear.material.itemId) >= gear.material.quantity &&
      inventory.getItemCount("spirit_stone") >= gear.spiritStoneCost
    );
  };
  const forgeDaoGear = (id: DaoGearId) => {
    ...
    if (inventory.getItemCount(gear.material.itemId) < gear.material.quantity) {
      showFloat(
        `${gear.material.name}不足，需要${gear.material.quantity}个。`,
        "danger",
      );
      return false;
    }
    ...
    addLog(
      `你消耗${gear.material.name}×${gear.material.quantity}、灵石×${gear.spiritStoneCost}，将${gear.name}淬炼至${current + 1}阶。`,
    );
  ...
  const maintainDaoGear = (id: DaoGearId) => {
    const gear = DAO_GEAR.find((g) => g.id === id);
    if (!gear) return false;
    if ((daoGear.value[id] || 0) <= 0) {
      showFloat("请先凝练装备。", "danger");
      return false;
    }
    if ((daoGearDurability.value[id] ?? 100) >= 100) {
      showFloat(`${gear.name}灵韧充盈。`, "accent");
      return false;
    }
    ...
    const inv = useInventoryStore();
    const player = usePlayerStore();
    if (inv.getItemCount(cost.material.itemId) < cost.materialQty) {
      showFloat(
        `${cost.material.name}不足，需要${cost.materialQty}。`,
        "danger",
      );
      return false;
    }
    if (inv.getItemCount("spirit_stone") < cost.spiritStone) {
      showFloat(`灵石不足，需要${cost.spiritStone}。`, "danger");
      return false;
    }
    if (!player.spendMoney(cost.money)) {
      showFloat(`铜钱不足，需要${cost.money}文。`, "danger");
      return false;
    }
    ...
    daoGearDurability.value = { ...daoGearDurability.value, [id]: 100 };
    addLog(
      `你以${cost.material.name}×${cost.materialQty}、灵石×${cost.spiritStone}并支付${cost.money}文，请炼器师重养${gear.name}灵韧。`,
    );
  ...
  const wearDaoGear = (amount = 2) => {
    ...
    for (const gear of DAO_GEAR)
      if ((daoGear.value[gear.id] || 0) > 0)
        next[gear.id] = Math.max(20, (next[gear.id] ?? 100) - amount);
  ...
  const beastAssistDesc = computed(() => {
    if (beast.value === "fox")
      return `协战：战斗胜利额外感应灵气，羁绊越高收益越多。`;
    if (beast.value === "crane")
      return `协战：战斗胜利额外沉淀修为，并强化战斗攻击。`;
    if (beast.value === "phoenix")
      return `协战：战斗胜利温养灵力，凶兽战有概率带回雷精。`;
    return "尚未结契灵兽。";
  });
  const beastDailyAvailable = computed(
    () => !!beast.value && beastTrainingDailyKey.value !== todayKey(),
  );
  const beastExpeditionName = computed(() =>
    beastExpedition.value?.type === "guard"
      ? "守卫洞府"
      : beastExpedition.value?.type === "expedition"
        ? "灵兽远征"
        : "空闲",
  );
  ...
  const setCultivationPath = (id: CultivationPathId) => {
    ...
    addLog(
      `你调整修行心境为「${currentCultivationPath.value.name}」，心境称号：${currentCultivationPath.value.title}。`,
    );
  ...
  const meditate = () => {
    ...
    let gain =
      12 + fieldTier.value * 6 + (spiritRoot.value === "mixed" ? 0 : 4);
    let manaGain = 12 + fieldTier.value * 4;
    let auraGain =
      5 + fieldTier.value * 3 + (spiritRoot.value === "mixed" ? 0 : 2);
    // Cave meditation room bonus
    if (hasCaveSlot("meditation")) {
      gain = Math.floor(gain * 2);
      manaGain = Math.floor(manaGain * 2);
    }
    // Crane bonus
    if (beast.value === "crane") {
      gain = Math.floor(gain * 1.4);
    }
    // Fox bonus
    if (beast.value === "fox") {
      auraGain = Math.floor(auraGain * 1.3);
    }
    // Cave aura regen
    auraGain += caveAuraRegen.value;
    const manualMultiplier =
      1 + manuals.value.wood * 0.05 + manuals.value.void * 0.03;
    if (cultivationPath.value === "balanced") {
      gain = Math.floor(gain * 1.08);
      manaGain = Math.floor(manaGain * 1.08);
      auraGain = Math.floor(auraGain * 1.05);
    }
    if (cultivationPath.value === "alchemy")
      auraGain = Math.floor(auraGain * 1.08);
    ...
    const cultivationResult = addCultivation(
      game.dailyFateType === "cultivation" ? Math.floor(gain * 1.1) : gain,
    );
    mana.value = Math.min(mana.value + manaGain, maxMana.value);
    aura.value += auraGain;
    const tr = game.advanceTime(1);
    addLog(
      `静坐调息一刻，消耗体力10，修为+${cultivationResult.actual}${game.dailyFateType === "cultivation" ? "（今日机缘加成）" : ""}，灵力+${manaGain}，灵气+${auraGain}${cultivationResult.auraGain ? `，溢出修为化为灵气+${cultivationResult.auraGain}` : ""}。`,
    );
  ...
  const refineAura = () => {
    ...
    const baseGain = Math.floor(
      spend *
        (1.15 +
          fieldTier.value * 0.12 +
          (artifacts.value.spiritKettle ? 0.18 : 0) +
          (cultivationPath.value === "alchemy" ? 0.16 : 0)),
    );
    const gain =
      game.dailyFateType === "cultivation"
        ? Math.floor(baseGain * 1.1)
        : baseGain;
    aura.value -= spend;
    const result = addCultivation(gain);
    wearDaoGear(1);
    addLog(
      `消耗体力5，炼化灵气${spend}点，修为增长${result.actual}${game.dailyFateType === "cultivation" ? "（今日机缘加成）" : ""}${result.auraGain ? `，溢出修为化为灵气+${result.auraGain}` : ""}。`,
    );
  ...
  const breakthrough = () => {
    ...
    if (major && Math.random() > tribulationSuccessRate.value) {
      ...
      const cultivationLoss = Math.max(
        1,
        Math.floor(maxCultivation.value * 0.18),
      );
      ...
      heartDemon.value = Math.min(
        100,
        heartDemon.value + 14 + Math.floor(realmIndex.value / 3),
      );
      ...
      if (yuanShenLevel.value > 0 && Math.random() < 0.45) {
        ...
        yuanShenExp.value = 0;
        addLog(
          `天雷贯体，突破失败！元神受创，元神等级跌落到${yuanShenLevel.value}。`,
        );
      } else {
        addLog(
          `天雷贯体，突破失败！修为受损${cultivationLoss}，灵力大损，元神伤势+1。`,
        );
      }
    ...
    addLog(
      `${major ? "雷云散去，天光垂落，" : "灵田上空清气回旋，"}你从「${old}」突破至「${realmName.value}」！${insightUsed > 0 ? ` 顿悟余韵护持本心（顿悟${insightUsed}）。` : ""}${demonBefore > 0 ? ` 心魔压力稍退（原${demonBefore}）。` : ""}`,
    );
  ...
  const addAuraFromHarvest = (cropId: string, qty = 1) => {
    ...
    const spiritCrop =
      cropId === "spirit_rice" ||
      cropId === "dew_grass" ||
      cropId === "vermilion_fruit" ||
      cropId === "ice_soul_lotus" ||
      cropId === "purple_ganoderma";
    if (!unlocked.value) {
      const pulseGain = Math.max(
        1,
        Math.floor(base * qty * (spiritCrop ? 8 : 2)),
      );
      const before = earthPulse.value;
      earthPulse.value = Math.min(100, earthPulse.value + pulseGain);
      if (before < 100 && earthPulse.value >= 100) {
        addLog(
          "连续耕作让你听见田垄下的灵脉回响，可以前往「修行」启蒙灵田了。",
        );
    ...
    const gain = Math.max(
      ...
      Math.floor(
        base *
          ...
          directRatio *
          (1 +
            fieldTier.value * 0.25 +
            artifactBonus +
            rainBonus +
            caveFarmBonus +
            foxBonus +
            (spiritCrop ? sectSpiritCropAuraBonusRate.value : 0)),
      ),
    );
    aura.value += gain;
  ...
  const meditateInSeclusion = () => {
    ...
    if (!player.consumeStamina(staminaCost)) {
      showFloat(`体力不足，闭关需要${staminaCost}点。`, "danger");
      return false;
    }
    if (mana.value < 30) {
      showFloat("灵力不足，闭关至少需要30点灵力。", "danger");
      return false;
    }
    const manaCost = Math.min(
      mana.value,
      30 + Math.floor(realmIndex.value * 1.5),
    );
    mana.value -= manaCost;
    const pathInsightBonus =
      cultivationPath.value === "thunder"
        ? 8
        : cultivationPath.value === "balanced"
          ? 4
    ...
    const gain = Math.floor(
      8 +
        fieldTier.value * 4 +
        yuanShenLevel.value * 0.8 +
        manuals.value.void * 5 +
        manuals.value.thunder * 3 +
        pathInsightBonus +
        (isMajorBreakthrough.value ? 10 : 0),
    );
    insight.value = Math.min(100, insight.value + gain);
    const pathDemonClear =
      cultivationPath.value === "balanced"
        ? 4
        : cultivationPath.value === "thunder"
          ? 2
          : 0;
    const demonClear = Math.min(
      heartDemon.value,
      5 +
        manuals.value.void +
        Math.floor(yuanShenLevel.value / 8) +
        pathDemonClear +
        sectDemonClearBonus.value,
    );
    heartDemon.value = Math.max(0, heartDemon.value - demonClear);
    useGameStore().advanceTime(1);
    addLog(
      `闭关参悟一刻，消耗体力${staminaCost}、灵力${manaCost}，顿悟+${gain}${demonClear ? `，心魔-${demonClear}` : ""}。`,
    );
  ...
  const triggerRealmEvent = (): string | null => {
    const inventory = useInventoryStore();
    const eligible = REALM_EVENTS.filter(
      (e) => e.chance > 0 && realmIndex.value >= e.minRealm,
    );
        ...
        switch (event.effect) {
          ...
          case "item":
            if (event.itemReward) {
              ...
              addLog(
                `${event.name}：${event.desc} 获得${event.itemReward.name}×${event.itemReward.qty}。`,
              );
            }
            break;
          case "artifact_hint":
  ...
  const doCultivationLesson = (id: CultivationLessonId) => {
    ...
    if (!lessonAvailable(id)) {
      showFloat("这门修行课业今日已经完成。", "danger");
      return false;
    }
    const player = usePlayerStore();
    const inventory = useInventoryStore();
    if (!player.consumeStamina(lesson.stamina)) {
      showFloat(`体力不足，需要${lesson.stamina}点。`, "danger");
      return false;
    }
    if ((lesson.auraCost || 0) > aura.value) {
      showFloat(`灵气不足，需要${lesson.auraCost}点。`, "danger");
      return false;
    }
    if ((lesson.manaCost || 0) > mana.value) {
      showFloat(`灵力不足，需要${lesson.manaCost}点。`, "danger");
      return false;
    }
    if (
      lesson.itemCost &&
      inventory.getItemCount(lesson.itemCost.itemId) < lesson.itemCost.quantity
    ) {
      showFloat(`${lesson.itemCost.name}不足。`, "danger");
      return false;
    }
    if (lesson.auraCost) aura.value -= lesson.auraCost;
    if (lesson.manaCost) mana.value -= lesson.manaCost;
    if (lesson.itemCost)
      inventory.removeItem(lesson.itemCost.itemId, lesson.itemCost.quantity);
    const pathLessonBonus =
      cultivationPath.value === "balanced" && lesson.id === "morning_breath"
        ? 0.12
        : cultivationPath.value === "sword" && lesson.id === "circulate_qi"
          ? 0.14
          : cultivationPath.value === "thunder" &&
              lesson.id === "thunder_contemplation"
            ? 0.16
            : 0;
    const tierBonus =
      1 +
      fieldTier.value * 0.1 +
      manuals.value.wood * 0.025 +
      manuals.value.void * 0.02 +
      (cultivationPath.value === "alchemy" ? 0.08 : 0);
    const auraGain = Math.floor((lesson.reward.aura || 0) * tierBonus);
    const cultivationGain = Math.floor(
      (lesson.reward.cultivation || 0) *
        (1 +
          realmIndex.value * 0.015 +
          manuals.value.wood * 0.03 +
          manuals.value.thunder * 0.02 +
          pathLessonBonus),
    );
    const manaGain = Math.floor(
      (lesson.reward.mana || 0) * (1 + manuals.value.void * 0.04),
    );
    const yuanShenGain = Math.floor(
      (lesson.reward.yuanShenExp || 0) *
        (1 + manuals.value.void * 0.03 + manuals.value.thunder * 0.02),
    );
    aura.value += auraGain;
    ...
    useGameStore().advanceTime(1);
    addLog(
      `完成修行课业「${lesson.name}」，灵气+${auraGain}，修为+${cultivationGain}，灵力+${manaGain}${yuanShenGain ? `，元神经验+${yuanShenGain}` : ""}。`,
    );
    showFloat(`${lesson.name}完成`, "success");
    return true;
  };
  const spiritMealAvailable = (id: SpiritMealId) =>
  ...
  const cookSpiritMeal = (id: SpiritMealId) => {
    ...
    if (fieldTier.value < recipe.minFieldTier) {
      showFloat(
        `需要${FIELD_TIERS[recipe.minFieldTier] || "更高阶灵田"}。`,
        "danger",
      );
      return false;
    }
    ...
    const tierBonus =
      1 + fieldTier.value * 0.12 + (hasCaveSlot("herbgarden") ? 0.18 : 0);
    const auraGain = Math.floor(recipe.aura * tierBonus);
    const cultivationGain = Math.floor(
      recipe.cultivation *
        (1 + fieldTier.value * 0.08 + (beast.value === "crane" ? 0.12 : 0)),
    );
    const manaGain = Math.floor(
      recipe.mana * (1 + (hasCaveSlot("meditation") ? 0.15 : 0)),
    );
    aura.value += auraGain;
    addCultivation(cultivationGain);
    mana.value = Math.min(maxMana.value, mana.value + manaGain);
    ...
    useGameStore().advanceTime(1);
    addLog(
      `烹成「${recipe.name}」，药食同源，灵气+${auraGain}，修为+${cultivationGain}，灵力+${manaGain}。`,
    );
  ...
  const rollAlchemyQuality = (): {
    ...
    const alchemySectBonus =
      sect.value === "alchemy"
        ? Math.min(
            0.16,
            0.02 * sectSkillTotal.value + 0.015 * (sectRank.value || 0),
          )
        : 0;
    const pathBonus = cultivationPath.value === "alchemy" ? 0.08 : 0;
    const highRealmBonus = Math.min(
      0.08,
      Math.max(0, realmIndex.value - 10) * 0.004,
    );
    ...
    const fineChance = Math.min(
      0.55,
      0.22 + caveBonus + alchemySectBonus + pathBonus + highRealmBonus,
    );
    ...
    if (roll < perfectChance + fineChance)
      return {
        quality: "fine",
        label: "上品",
        outputBonus: 0,
  ...
  const applyAlchemyQualityBonus = (
    pillId: PillId,
    quality: AlchemyQuality,
    bonusRate: number,
  ): string => {
    ...
    if (
      ...
      pillId === "lianjing_pill" ||
      pillId === "huaqi_pill" ||
      pillId === "lianqi_pill" ||
      pillId === "huashen_pill" ||
      pillId === "lianshen_pill" ||
      pillId === "ganoderma_pill"
    ) {
      const gain = Math.max(
        30,
        Math.floor(
          (ALCHEMY_RECIPES[pillId].aura + ALCHEMY_RECIPES[pillId].mana * 3) *
            bonusRate,
        ),
      );
      addCultivation(gain);
    ...
    if (
      ...
      pillId === "returning_void_pill" ||
      pillId === "refining_void_pill" ||
      pillId === "merge_way_pill"
    ) {
      const blessing = Math.max(
        120,
        Math.floor(ALCHEMY_RECIPES[pillId].aura * bonusRate),
      );
    ...
    if (pillId === "snow_lotus_pill" || pillId === "ice_soul_pill") {
      ...
      insight.value = Math.min(
        100,
        insight.value + (quality === "perfect" ? 6 : 3),
      );
      return `清心丹香，顿悟+${quality === "perfect" ? 6 : 3}${clear ? `，心魔-${clear}` : ""}`;
    }
    if (
      pillId === "soul_mending_pill" ||
      pillId === "nirvana_soul_pill" ||
      pillId === "good_fortune_pill"
    ) {
    ...
    const auraGain = Math.max(
      20,
      Math.floor(ALCHEMY_RECIPES[pillId].aura * bonusRate * 0.5),
    );
    aura.value += auraGain;
  ...
  const craftPill = (pillId: PillId) => {
    ...
    if (
      (recipe as any).minRealm &&
      realmIndex.value < (recipe as any).minRealm
    ) {
      showFloat(
    ...
    const extraOutput =
      Math.random() < sectAlchemyExtraOutputChance.value ? 1 : 0;
    const finalOutput = recipe.output + extraOutput + quality.outputBonus;
    const bonusText = applyAlchemyQualityBonus(
      pillId,
      quality.quality,
      quality.bonusRate,
    );
    lastAlchemyQuality.value = {
      pillId,
    ...
    addLog(
      `炼成${quality.label}${recipe.name}×${finalOutput}${extraOutput ? "（丹宗加成，额外成丹）" : ""}${quality.outputBonus ? "（极品加成，额外成丹）" : ""}${bonusText ? `；${bonusText}` : ""}。`,
    );
    showFloat(
      `${quality.label}${recipe.name}+${finalOutput}`,
      quality.quality === "perfect" ? "accent" : "success",
    );
    return true;
  };

  const gainIdleCultivation = (minutes: number) => {
    if (!unlocked.value || minutes <= 0)
      return { aura: 0, cultivation: 0, yuanShen: 0 };
    ...
    const auraGain = Math.max(
      ...
      Math.floor(
        capped *
          (1.2 +
            fieldTier.value * 0.35 +
            caveAuraRegen.value * 0.08 +
            (hasCaveSlot("spiritArray") ? 0.8 : 0) +
            manuals.value.wood * 0.12),
      ),
    );
    const cultivationGain = Math.max(
      ...
      Math.floor(
        capped *
          (4 +
            realmIndex.value * 0.28 +
            fieldTier.value * 0.8 +
            (hasCaveSlot("meditation") ? 3 : 0) +
            (beast.value === "crane" ? 2 : 0) +
            manuals.value.void * 0.25),
      ),
    );
    const yuanShenGain = Math.max(
      0,
      Math.floor(capped / 30) +
        (hasCaveSlot("meditation") ? Math.floor(capped / 60) : 0),
    );
    aura.value += auraGain;
    addCultivation(cultivationGain);
    if (yuanShenGain > 0) addYuanShenExp(yuanShenGain);
  ...
  const learnManual = (key?: string): { success: boolean; message: string } => {
    if (!unlocked.value)
      return { success: false, message: "启蒙灵田后才能研读功法。" };
    if (key !== "wood" && key !== "thunder" && key !== "void")
      return { success: false, message: "功法秘籍无效。" };
    if (manuals.value[key] > 0)
      return {
        success: false,
        message: `你已经学会${CULTIVATION_MANUALS[key].name}。`,
      };
    manuals.value[key] = 1;
    showFloat(`习得${CULTIVATION_MANUALS[key].name}`, "success");
    return {
      success: true,
      message: `研读秘籍，习得功法「${CULTIVATION_MANUALS[key].name}」！`,
    };
  };
  ...
  const upgradeManual = (
    ...
    if (aura.value < auraNeed || cultivation.value < cultivationNeed)
      return {
        success: false,
        message: `资源不足：需要灵气${auraNeed}、修为${cultivationNeed}。`,
      };
    aura.value -= auraNeed;
  ...
  const unlockArtifact = (key: ArtifactKey) => {
    ...
    if (aura.value < c.aura || player.money < c.money) {
      showFloat(
        `${ARTIFACT_NAMES[key]}需要灵气${c.aura}、铜钱${c.money}。`,
        "danger",
      );
      return false;
    }
  ...
  const openCave = () => {
    if (!unlocked.value) return unlock();
    if (caveTier.value > 0) {
      showFloat("已有洞府。", "danger");
      return false;
    }
    const player = usePlayerStore();
    if (!player.spendMoney(8000)) {
      showFloat("铜钱不足，需要8000文开辟洞府。", "danger");
      return false;
    }
    if (aura.value < 200) {
      showFloat("灵气不足，需要200点。", "danger");
      return false;
    }
    aura.value -= 200;
    caveTier.value = 1;
  ...
  const upgradeCave = () => {
    ...
    if (caveTier.value >= CAVE_TIERS.length - 1) {
      showFloat("洞府已达最高等阶。", "danger");
      return false;
    }
    const next = CAVE_TIERS[caveTier.value + 1]!;
    if (aura.value < next.cost) {
      showFloat(`灵气不足，需要${next.cost}点。`, "danger");
      return false;
    }
    ...
    addLog(
      `洞府扩建为「${caveTierName.value}」，可用槽位${caveMaxSlots.value}个，每日灵气恢复+${caveAuraRegen.value}。`,
    );
  ...
  const placeCaveSlot = (type: CaveSlotType) => {
    if (caveTier.value <= 0) {
      showFloat("请先开辟洞府。", "danger");
      return false;
    }
    if (caveSlots.value.includes(type)) {
      showFloat("已安置此设施。", "danger");
      return false;
    }
    if (caveSlots.value.length >= caveMaxSlots.value) {
      showFloat("洞府槽位已满，请先扩建。", "danger");
      return false;
    }
    const player = usePlayerStore();
    const cost =
    ...
    addLog(
      `洞府内安置了「${CAVE_SLOT_DATA[type].name}」——${CAVE_SLOT_DATA[type].desc}`,
    );
  ...
  const caveNeedsMaintenance = computed(
    () => caveTier.value > 0 && caveStability.value < 100,
  );
  const maintainCave = () => {
    if (caveTier.value <= 0) {
      showFloat("请先开辟洞府。", "danger");
    ...
    if (caveStability.value >= 100) {
      showFloat("洞府灵脉稳定，无需维护。", "accent");
      return false;
    }
    const cost = caveMaintenanceCost.value;
    const inv = useInventoryStore();
    const player = usePlayerStore();
    if (aura.value < cost.aura) {
      showFloat(`灵气不足，需要${cost.aura}。`, "danger");
      return false;
    }
    if (inv.getItemCount("spirit_stone") < cost.spiritStone) {
      showFloat(`灵石不足，需要${cost.spiritStone}。`, "danger");
    ...
    caveMaintenanceKey.value = todayKey();
    addLog(
      `你整修洞府灵脉，消耗铜钱${cost.money}、灵气${cost.aura}、灵石×${cost.spiritStone}，洞府稳定恢复。`,
    );
  ...
  const dailyCaveMaintenanceUpdate = () => {
    ...
    const loss = Math.min(
      45,
      days * (4 + caveTier.value + caveSlots.value.length),
    );
    caveStability.value = Math.max(45, caveStability.value - loss);
    caveMaintenanceKey.value = today;
    if (caveStability.value < 80)
      return `洞府灵脉稳定降至${caveStability.value}，恢复收益下降，可在洞府维护。`;
    return "";
  };
  ...
  const encounterBeast = () => {
    if (!unlocked.value) return unlock();
    if (beast.value) {
      showFloat("你已有灵兽伙伴。", "danger");
      return false;
    }
    const cost = 30;
    if (mana.value < cost) {
      showFloat("灵力不足，需要30点引灵。", "danger");
      return false;
    }
    mana.value -= cost;
    const game = useGameStore();
    ...
    // Random encounter
    const roll = Math.random();
    const chosen: BeastId =
      roll < 0.4 ? "fox" : roll < 0.75 ? "crane" : "phoenix";
    beast.value = chosen;
    beastBond.value = 10;
    addLog(
      `你循灵气而行，在一处灵泉边遇到了${BEAST_DATA[chosen].emoji}${BEAST_DATA[chosen].name}！它似乎愿意跟随你修行。`,
    );
  ...
  const feedBeast = () => {
    if (!beast.value) {
      showFloat("你还没有灵兽伙伴。", "danger");
      return false;
    }
    const data = BEAST_DATA[beast.value];
    const inventory = useInventoryStore();
    const feedName =
      data.feedCrop === "dew_grass"
        ? "凝露草"
        : data.feedCrop === "spirit_rice"
          ? "蕴灵稻"
          : "朱果";
  ...
  const startBeastExpedition = (type: "guard" | "expedition") => {
    ...
    if (beastBond.value < 300) {
      showFloat("灵兽羁绊达到同心后才能派遣。", "danger");
      return false;
    }
    ...
    addLog(
      `${beastEmoji.value}${beastName.value}开始${type === "guard" ? "守卫洞府" : "外出远征"}。`,
    );
  ...
  const dailyBeastExpeditionUpdate = () => {
    ...
    if (beast.value === "phoenix" || Math.random() < 0.35)
      inventory.addItem("thunder_essence", 1);
  ...
  const trainBeastDaily = () => {
    ...
    if (!beastDailyAvailable.value) {
      showFloat("今日已陪练过灵兽。", "danger");
      return false;
    }
    const player = usePlayerStore();
    if (!player.consumeStamina(8)) {
      showFloat("体力不足，陪练需要8点体力。", "danger");
      return false;
    }
    if (mana.value < 12) {
      showFloat("灵力不足，陪练需要12点灵力。", "danger");
      return false;
    }
    mana.value -= 12;
    const level = beastLevel.value;
    ...
    if (beast.value === "fox") {
      ...
      aura.value += gain;
      addLog(
        `你陪${beastEmoji.value}${beastName.value}巡游灵田，羁绊+${bondGain}，灵气+${gain}。`,
      );
      ...
      addCultivation(gain);
      addLog(
        `你随${beastEmoji.value}${beastName.value}演练身法，羁绊+${bondGain}，修为+${gain}。`,
      );
      ...
      insight.value += 2;
      addLog(
        `你与${beastEmoji.value}${beastName.value}引火温神，羁绊+${bondGain}，灵力+${gain}，顿悟+2。`,
      );
  ...
  const realDailyPendingDays = (last?: string) => {
    ...
    return Math.max(
      0,
      Math.min(
        REAL_DAILY_ACCUMULATION_CAP,
        Math.floor((todayMs - lastMs) / MS_PER_DAY),
      ),
    );
  };
  ...
  const spiritArrayElementYield = computed(
  ...
  const claimDailyHerbs = () => {
    if (!hasCaveSlot("herbgarden")) {
      showFloat("请先在洞府安置百草园。", "danger");
      return false;
    }
    const days = herbClaimDays.value;
    if (days <= 0) {
      showFloat("今日药材已领取。", "danger");
      return false;
    }
    const inventory = useInventoryStore();
  ...
  const claimDailyElements = () => {
    if (!hasCaveSlot("spiritArray")) {
      showFloat("请先在洞府安置聚灵阵。", "danger");
      return false;
    }
    const days = spiritArrayClaimDays.value;
    if (days <= 0) {
      showFloat("今日五行元气已凝聚。", "danger");
      return false;
    }
    ...
    for (const key of ["wood", "water", "earth", "fire", "metal"])
      elements.value[key] = (elements.value[key] ?? 0) + totalElement;
    useInventoryStore().addItem("spirit_stone", stones);
    spiritArrayLastDaily.value = todayKey();
    addLog(
      `聚灵阵按现实日期凝聚${days}天五行元气，每种+${totalElement}，并产出灵石${stones}枚。`,
    );
  ...
  const refineSpiritStoneToAura = () => {
    ...
    spiritStoneRefineDailyCount.value++;
    addLog(
      `灵石坊炼气：消耗灵石×${cost}，转化为灵气+${gain}。今日第${spiritStoneRefineDailyCount.value}/${spiritStoneRefineLimit.value}次，后续成本会递增。`,
    );
  ...
  const forgeDestinedArtifact = (id: string) => {
    if (!unlocked.value) return unlock();
    if (destinedArtifact.value) {
      showFloat("已有本命法宝。", "danger");
      return false;
    }
    const player = usePlayerStore();
    if (aura.value < 2000 || !player.spendMoney(20000)) {
      showFloat("炼制需要灵气2000、铜钱20000。", "danger");
      return false;
    }
    aura.value -= 2000;
  ...
  const resetDestinedArtifactDaily = () => {
    const key = todayKey();
    if (destinedArtifactDailyKey.value !== key) {
      destinedArtifactDailyKey.value = key;
      destinedArtifactDailyCount.value = 0;
    }
  };

  const activateDestinedArtifact = () => {
    if (!destinedArtifact.value) {
      showFloat("请先炼制本命法宝。", "danger");
      return false;
    }
    resetDestinedArtifactDaily();
    if (destinedArtifactDailyCount.value >= destinedArtifactActiveLimit.value) {
      showFloat("今日法宝威能已耗尽。", "danger");
      return false;
    }
    const level = Math.max(1, destinedArtifactLevel.value);
    const manaCost = Math.max(12, 26 - Math.floor(level / 2));
    if (mana.value < manaCost) {
      showFloat(`灵力不足，需要${manaCost}点。`, "danger");
      return false;
    }
    mana.value -= manaCost;
    ...
    if (destinedArtifact.value === "qixing_sword") {
      ...
      aura.value += auraGain;
      heartDemon.value = Math.max(
        0,
        heartDemon.value - (4 + Math.floor(level / 2)),
      );
      addLog(
        `七星剑主动威能「七星斩念」发动：灵力-${manaCost}，修为+${cultivationGain}，灵气+${auraGain}，心魔降低。`,
      );
      showFloat("七星斩念", "success");
      return true;
    }
    if (destinedArtifact.value === "taiji_mirror") {
      ...
      yuanShenInjury.value = Math.max(
        0,
        yuanShenInjury.value - Math.max(1, Math.floor(level / 4)),
      );
      addLog(
        `太极镜主动威能「太极护心」发动：灵力-${manaCost}后回转+${manaRecover}，洞府稳定+${stabilityGain}，元神伤势缓解。`,
      );
    ...
    addLog(
      `青莲灯主动威能「青莲照心」发动：灵力-${manaCost}，悟道+${insightGain}，灵气+${lotusAura}，心魔净化。`,
    );
    showFloat("青莲照心", "success");
    return true;
  };
  ...
  const destinedArtifactActiveRemaining = computed(() => {
    if (destinedArtifactDailyKey.value !== todayKey())
      return destinedArtifactActiveLimit.value;
    return Math.max(
      0,
      destinedArtifactActiveLimit.value - destinedArtifactDailyCount.value,
    );
  });
  const destinedArtifactActiveDesc = computed(() => {
    if (destinedArtifact.value === "qixing_sword")
      return "七星斩念：消耗灵力斩除心魔，获得修为与灵气；法宝等级越高收益越高。";
    if (destinedArtifact.value === "taiji_mirror")
      return "太极护心：调和阴阳，恢复灵力并修复洞府稳定，轻微疗愈元神伤势。";
    if (destinedArtifact.value === "azure_lotus")
      return "青莲照心：点亮青莲心灯，获得悟道与灵气，并净化心魔。";
    return "炼成本命法宝后可释放主动威能。";
  });
  const talismanUnlocked = computed(
    () => Object.keys(talismans.value).length > 0 || realmIndex.value >= 3,
  );
  const talismanCount = computed(() =>
    Object.values(talismans.value).reduce((sum, n) => sum + n, 0),
  );
  const unlockTalisman = () => {
    const player = usePlayerStore();
    if (!player.spendMoney(15000)) {
      showFloat("铜钱不足，需要15000文。", "danger");
      return false;
    }
  ...
  const craftTalisman = (type: TalismanId | string) => {
    if (!isTalismanId(type)) {
      showFloat("未知符箓。", "danger");
      return false;
    }
    const cost = sect.value === "talisman" ? 24 : 30;
    if (mana.value < cost) {
      showFloat(`灵力不足，需要${cost}点。`, "danger");
      return false;
    }
    mana.value -= cost;
    ...
    addLog(
      `绘成一枚「${def.name}」，${def.effect}${sect.value === "talisman" ? "符宗法脉使其效力更稳。" : ""}`,
    );
    showFloat(`${def.name}+1`, "success");
    return true;
  };
  const useTalisman = (type: TalismanId | string) => {
    ...
    if ((talismans.value[type] || 0) <= 0) {
      showFloat("没有可用符箓。", "danger");
      return false;
    }
  ...
  const rebirthCost = computed(() => ({
    aura: 100000 * (rebirthCount.value + 1),
    money: 50000 * (rebirthCount.value + 1),
  }));
  const rebirthMaterials = computed<RebirthMaterialCost[]>(() => {
    const nextTurn = rebirthCount.value + 1;
    const costs: RebirthMaterialCost[] = [
      { itemId: "rebirth_pill", name: "轮回丹", quantity: 1 },
    ];
    ...
    if (jade > 0)
      costs.push({ itemId: "lingyun_jade", name: "灵蕴玉", quantity: jade });
    return costs;
  });
  const hasRebirthMaterials = computed(() => {
    const inventory = useInventoryStore();
    return rebirthMaterials.value.every(
      (m) => inventory.getItemCount(m.itemId) >= m.quantity,
    );
  });
  const canRebirth = computed(
    () =>
      realmIndex.value >= 20 &&
      aura.value >= rebirthCost.value.aura &&
      usePlayerStore().money >= rebirthCost.value.money &&
      hasRebirthMaterials.value,
  );
  const rebirth = () => {
    if (realmIndex.value < 20) {
      showFloat("需达到大乘初期后方可转生。", "danger");
      return false;
    }
    if (aura.value < rebirthCost.value.aura) {
      showFloat(`灵气不足，需要${rebirthCost.value.aura}。`, "danger");
      return false;
    }
    const player = usePlayerStore();
    if (player.money < rebirthCost.value.money) {
      showFloat(`铜钱不足，需要${rebirthCost.value.money}文。`, "danger");
      return false;
    }
    const inventory = useInventoryStore();
    const missing = rebirthMaterials.value.find(
      (m) => inventory.getItemCount(m.itemId) < m.quantity,
    );
    if (missing) {
      showFloat(
        `转生材料不足：${missing.name}×${missing.quantity}。`,
        "danger",
      );
      return false;
    }
    const consumedJade =
      rebirthMaterials.value.find((m) => m.itemId === "lingyun_jade")
        ?.quantity || 0;
    for (const m of rebirthMaterials.value)
  ...
  const serialize = () => ({
    ...
    caveTier: caveTier.value,
    caveSlots: caveSlots.value,
    caveStability: caveStability.value,
    caveMaintenanceKey: caveMaintenanceKey.value,
    herbGardenLevel: herbGardenLevel.value,
    herbLastDaily: herbLastDaily.value,
    herbs: herbs.value,
    spiritArrayLevel: spiritArrayLevel.value,
    spiritArrayLastDaily: spiritArrayLastDaily.value,
    spiritStoneRefineDailyKey: spiritStoneRefineDailyKey.value,
    spiritStoneRefineDailyCount: spiritStoneRefineDailyCount.value,
    elements: elements.value,
    yuanShenLevel: yuanShenLevel.value,
    yuanShenExp: yuanShenExp.value,
    yuanShenInjury: yuanShenInjury.value,
    destinedArtifact: destinedArtifact.value,
    destinedArtifactLevel: destinedArtifactLevel.value,
    destinedArtifactDailyKey: destinedArtifactDailyKey.value,
    destinedArtifactDailyCount: destinedArtifactDailyCount.value,
    talismans: talismans.value,
    talismanCooldown: talismanCooldown.value,
    rebirthCount: rebirthCount.value,
    rebirthBonus: rebirthBonus.value,
    lingYun: lingYun.value,
    rebirthUnlocked: rebirthUnlocked.value,
    beast: beast.value,
    beastBond: beastBond.value,
    beastTrainingDailyKey: beastTrainingDailyKey.value,
    beastExpedition: beastExpedition.value,
    sect: sect.value,
    sectSkills: sectSkills.value,
    sectContribution: sectContribution.value,
    sectRank: sectRank.value,
    sectMerit: sectMerit.value,
    sectDailyKey: sectDailyKey.value,
    sectDailyDone: sectDailyDone.value,
    manuals: manuals.value,
    autoMeditateEnabled: autoMeditateEnabled.value,
    autoMeditateCount: autoMeditateCount.value,
  });
  const deserialize = (data?: Partial<ReturnType<typeof serialize>>) => {
    ...
    alchemyUnlocked.value = (data as any).alchemyUnlocked ?? false;
    {
      ...
      daoGear.value = {
        immortal_sword: Math.max(
          Number(oldGear.immortal_sword || 0),
          Number(oldGear.spirit_sword || 0),
        ),
        dharma_robe: Math.max(
          Number(oldGear.dharma_robe || 0),
          Number(oldGear.spirit_robe || 0),
        ),
        cloud_boots: Number(oldGear.cloud_boots || 0),
        tribulation_amulet: Math.max(
          Number(oldGear.tribulation_amulet || 0),
          Number(oldGear.thunder_talisman || 0),
        ),
      };
      const oldDur = ((data as any).daoGearDurability ?? {}) as Record<
        string,
        number
      >;
    ...
    spiritMealLastDaily.value = {
      plain_spirit_porridge: "",
      dew_rice_soup: "",
      vermilion_elixir_soup: "",
      three_treasure_spirit_meal: "",
      ...((data as any).spiritMealLastDaily ?? {}),
    };
    artifacts.value = {
      glimmerHoe: false,
      spiritKettle: false,
      spiritRain: false,
      ...((data as any).artifacts ?? {}),
    };
    ...
    caveMaintenanceKey.value = String(
      (data as any).caveMaintenanceKey ?? todayKey(),
    );
    ...
    spiritStoneRefineDailyKey.value =
      (data as any).spiritStoneRefineDailyKey ?? "";
    spiritStoneRefineDailyCount.value =
      (data as any).spiritStoneRefineDailyCount ?? 0;
    ...
    destinedArtifactDailyKey.value =
      (data as any).destinedArtifactDailyKey ?? "";
    destinedArtifactDailyCount.value =
      (data as any).destinedArtifactDailyCount ?? 0;
    ...
    if (rebirthBonus.value > 0 && rebirthBonus.value < 1)
      rebirthBonus.value = Math.round(rebirthBonus.value * 100);
    ...
    autoMeditateEnabled.value = Boolean(
      (data as any).autoMeditateEnabled ?? false,
    );
  ...
  return {
    ...
    heartDemon,
    cultivationPath,
    currentCultivationPath,
    pathTitle,
    spiritMealLastDaily,
    artifacts,
    foundationPillBlessing,
    caveTier,
    caveSlots,
    caveStability,
    caveStabilityRate,
    caveMaintenanceCost,
    caveNeedsMaintenance,
    maintainCave,
    dailyCaveMaintenanceUpdate,
    herbGardenLevel,
    herbLastDaily,
    herbs,
    spiritArrayLevel,
    ...
    destinedArtifactActiveRemaining,
    destinedArtifactActiveDesc,
    talismans,
    talismanCooldown,
    rebirthCount,
    rebirthBonus,
    lingYun,
    rebirthUnlocked,
    talismanRechargeRate,
    talismanPower,
    talismanTribulationBonus,
    yuanShenBonus,
    rebirthRealmName,
    beast,
    beastBond,
    ...
    sectDailyKey,
    sectDailyDone,
    sectCombatAttackBonusRate,
    sectCombatDefenseBonusRate,
    sectMaxHpBonusRate,
    sectAlchemyExtraOutputChance,
    sectSpiritCropAuraBonusRate,
    sectDemonClearBonus,
    manuals,
    autoMeditateEnabled,
    autoMeditateCount,
    ...
    herbClaimDays,
    herbDailyYield,
    spiritArrayClaimDays,
    spiritArrayElementYield,
    spiritArrayStoneYield,
    spiritStoneRefineLimit,
    spiritStoneRefineCountToday,
    ...
    forgeDestinedArtifact,
    upgradeDestinedArtifact,
    activateDestinedArtifact,
    craftTalisman,
    useTalisman,
    cultivateYuanShen,
    trainYuanShen,
