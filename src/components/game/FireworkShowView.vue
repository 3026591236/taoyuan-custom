  ...
  <div class="game-panel max-w-sm w-full">
    ...
    <div v-if="phase === 'ready'">
      <p class="text-xs text-muted mb-3">
        记住烟花绽放的顺序，然后按顺序点击复现！共5轮，每轮多一个位置，考验你的记忆力！
      </p>
      ...
      <div v-if="phase === 'repeating'" class="mb-2">
        <div class="flex items-center justify-between mb-1">
          ...
          <p
            class="text-xs"
            :class="
              recallTimeLeft <= 3 ? 'text-danger time-pulse' : 'text-accent'
            "
          >
            {{ recallTimeLeft }}s
          </p>
        ...
        >
          ...
          >
            ...
            <Asterisk
              :size="10"
              class="particle p1"
              :style="{ color: fireworkColors[i - 1] }"
            />
            <Asterisk
              :size="10"
              class="particle p2"
          ...
          <span
            ...
            :class="phase === 'repeating' ? 'text-accent/50' : 'text-accent/20'"
            >{{ i }}</span
          >
        </button>
      </div>
    ...
    <div v-else>
      ...
      <div class="border border-accent/20 p-3 mb-3 text-center">
        ...
        <p class="text-xs">
          ...
          <span class="text-accent">{{ score }}</span>
          文
          <span v-if="completedRounds === 5" class="text-accent finish-flash"
            >（全通+200文！）</span
          >
        </p>
      </div>
