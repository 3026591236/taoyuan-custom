    ...
    <div class="flex space-x-2 items-end justify-center">
      ...
      >
        ...
        <div
          ...
          :style="{
            top: CONTAINER_HEIGHT - hookPos - hookHeight + 'px',
        ...
        <div
          ...
          :style="{ top: fishPos + 'px', height: FISH_HEIGHT + 'px' }"
        />
      </div>
...
const gameLoop = (timestamp: number) => {
  ...
  if (isHolding.value) {
    hookPos.value = Math.min(
      hookPos.value + props.liftSpeed,
      CONTAINER_HEIGHT - props.hookHeight,
    );
  } else {
