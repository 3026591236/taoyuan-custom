  ...
  <div class="immortal-page" :class="`art-${ascensionStore.lastArtId}`">
    ...
    <div v-if="isTab('home')" class="immortal-hero relative z-10 mb-4">
      ...
      <div class="flex-1 min-w-0 immortal-profile">
        ...
        <div class="combat-core-grid mt-3">
          <div class="combat-power"><span>仙战力</span><b>{{ ascensionStore.immortalPower }}</b><small>综合仙界战力</small></div>
          <div class="combat-vitals"><div class="vital-row"><span>气血</span><b>{{ ascensionStore.immortalHp }}/{{ ascensionStore.immortalMaxHp }}</b></div><div class="vital-bar hp"><i :style="{ width: `${ascensionStore.immortalHpRate}%` }"></i></div><div class="vital-row"><span>仙力</span><b>{{ ascensionStore.immortalQi }}/{{ ascensionStore.immortalMaxQi }}</b></div><div class="vital-bar qi"><i :style="{ width: `${ascensionStore.immortalQiRate}%` }"></i></div></div>
        ...
        <div class="grid grid-cols-4 gap-1.5 mt-2 text-center resource-row"><div class="stat"><b>{{ ascensionStore.merit }}</b><span>功德</span></div><div class="stat"><b>{{ ascensionStore.immortalJade }}</b><span>仙玉</span></div><div class="stat"><b>{{ ascensionStore.ruleFragments }}</b><span>法则</span></div><div class="stat"><b>{{ ascensionStore.immortalEssence }}</b><span>器魄</span></div></div>
