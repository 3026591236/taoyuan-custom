...
/* V2.8.1 大厅角色档案重构：立绘为主，数据为环绕式战斗 HUD */
.immortal-hero{position:relative;display:grid!important;grid-template-columns:250px minmax(0,1fr);gap:20px;align-items:stretch;min-height:368px;padding:20px 22px 22px;overflow:hidden;border:1px solid rgba(255,226,138,.32);border-radius:12px;background:radial-gradient(ellipse at 12% 28%,rgba(108,212,255,.18),transparent 34%),radial-gradient(ellipse at 78% 3%,rgba(255,221,133,.16),transparent 32%),linear-gradient(118deg,rgba(8,16,46,.97),rgba(20,14,59,.92) 58%,rgba(5,13,38,.96));box-shadow:0 16px 40px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.1)}
.immortal-hero::before{content:'';position:absolute;left:-100px;bottom:-140px;width:450px;height:280px;border:1px solid rgba(126,229,255,.16);border-radius:50%;transform:rotate(-14deg);box-shadow:0 0 45px rgba(98,211,255,.14)}
.hero-avatar.immortal-portrait-stage{z-index:1;width:250px;height:326px;align-self:end;border-radius:120px 120px 18px 18px;border-color:rgba(255,230,151,.56);box-shadow:0 0 45px rgba(255,221,129,.18),0 14px 35px rgba(0,0,0,.36),inset 0 0 34px rgba(132,223,255,.16)}
