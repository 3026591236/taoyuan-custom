<template>
  <div class="immortal-page" :class="`art-${ascensionStore.lastArtId}`">
    ...
    <div v-if="isTab('realm')" class="realm-sanctum relative z-10 mb-4" :class="`realm-stage-${ascensionStore.immortalRealmStage}`">
      ...
      <div v-if="ascensionStore.immortalBreakthroughFx" class="breakthrough-cinematic" @animationend="finishBreakthroughFx"><div class="fx-heaven-mark"></div><div class="fx-lightning l1"></div><div class="fx-lightning l2"></div><div class="fx-sword-light"></div><div class="fx-ring r1"></div><div class="fx-ring r2"></div><p>{{ ascensionStore.immortalBreakthroughFx.icon }}</p><h4>破境 · {{ ascensionStore.immortalBreakthroughFx.name }}</h4><span>仙光入体　法则重铸</span></div>
    </div>
...
const finishBreakthroughFx = () => ascensionStore.clearImmortalBreakthroughFx()
