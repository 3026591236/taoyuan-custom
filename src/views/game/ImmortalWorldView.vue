<template>
  <div class="immortal-page" :class="`art-${ascensionStore.lastArtId}`">
    ...
    <div v-if="isTab('home')" class="immortal-hero relative z-10 mb-4">
      <div class="hero-avatar immortal-portrait-stage" :key="ascensionStore.visualPulse" aria-label="仙界角色立绘">
        <div class="immortal-gate gate-back"></div>
        <div class="immortal-gate gate-front"></div>
        <div class="portrait-star star-a"></div><div class="portrait-star star-b"></div><div class="portrait-star star-c"></div>
        <div class="portrait-orbit orbit-a"></div><div class="portrait-orbit orbit-b"></div><div class="portrait-orbit orbit-c"></div>
        <svg class="immortal-full-figure" viewBox="0 0 260 420" role="img" aria-hidden="true">
          <defs>
            <linearGradient id="v268Skin" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#fff8df"/><stop offset="1" stop-color="#ffd5b4"/></linearGradient>
            <linearGradient id="v268Hair" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset=".45" stop-color="#e7f6ff"/><stop offset="1" stop-color="#96bfff" stop-opacity=".55"/></linearGradient>
            <linearGradient id="v268Robe" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff2a3"/><stop offset=".22" stop-color="#fffef2"/><stop offset=".52" stop-color="#80e5ff"/><stop offset=".78" stop-color="#a98dff"/><stop offset="1" stop-color="#543f93"/></linearGradient>
            <linearGradient id="v268Inner" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset=".58" stop-color="#d6fbff"/><stop offset="1" stop-color="#725edb"/></linearGradient>
            <linearGradient id="v268Gold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fffbd0"/><stop offset=".5" stop-color="#ffd86e"/><stop offset="1" stop-color="#b77625"/></linearGradient>
            <linearGradient id="v268Blade" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset=".45" stop-color="#9ff2ff"/><stop offset="1" stop-color="#7b6dff" stop-opacity=".18"/></linearGradient>
            <filter id="v268Glow"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
            <filter id="v268Soft"><feGaussianBlur stdDeviation="7"/></filter>
          </defs>
          <ellipse cx="130" cy="386" rx="92" ry="20" fill="#7ee8ff" opacity=".22" filter="url(#v268Soft)"/>
          <path d="M130 35 C82 76 57 142 61 218 C64 289 36 333 20 374 C73 347 105 297 115 219 C122 153 114 83 130 35Z" fill="url(#v268Hair)" opacity=".88"/>
          <path d="M130 35 C178 76 203 142 199 218 C196 289 224 333 240 374 C187 347 155 297 145 219 C138 153 146 83 130 35Z" fill="url(#v268Hair)" opacity=".88"/>
          <path d="M130 14 L148 49 L190 56 L160 84 L167 126 L130 106 L93 126 L100 84 L70 56 L112 49Z" fill="url(#v268Gold)" filter="url(#v268Glow)"/>
          <path d="M88 50 C103 28 157 28 172 50 C159 70 102 70 88 50Z" fill="url(#v268Gold)" opacity=".75"/>
          <circle cx="130" cy="92" r="34" fill="url(#v268Skin)" stroke="#fff1b5" stroke-width="3" filter="url(#v268Glow)"/>
          <path d="M94 82 C106 66 154 66 166 82 C154 61 109 58 94 82Z" fill="#f7fbff" opacity=".72"/>
          <circle cx="116" cy="91" r="4" fill="#5b302a" opacity=".78"/><circle cx="144" cy="91" r="4" fill="#5b302a" opacity=".78"/>
          <path d="M118 109 C126 116 136 116 144 109" fill="none" stroke="#9b5a4d" stroke-width="3" stroke-linecap="round" opacity=".62"/>
          <path d="M83 143 C103 121 157 121 177 143 L213 348 C171 395 89 395 47 348Z" fill="url(#v268Robe)" stroke="#fff0a6" stroke-width="3.5" filter="url(#v268Glow)"/>
          <path d="M108 139 C98 198 96 283 82 364 C101 379 159 379 178 364 C164 283 162 198 152 139 C140 151 120 151 108 139Z" fill="url(#v268Inner)" opacity=".92"/>
          <path d="M77 159 C47 204 35 253 5 292 C42 305 82 276 105 218Z" fill="#f4fdff" opacity=".9" stroke="#bbf3ff" stroke-width="2"/>
          <path d="M183 159 C213 204 225 253 255 292 C218 305 178 276 155 218Z" fill="#f4fdff" opacity=".9" stroke="#bbf3ff" stroke-width="2"/>
          <path d="M57 245 C99 269 161 269 203 245" stroke="#fff0a8" stroke-width="13" stroke-linecap="round" opacity=".92" filter="url(#v268Glow)"/>
          <path d="M74 271 C109 286 151 286 186 271" stroke="#8df1ff" stroke-width="5" stroke-linecap="round" opacity=".75"/>
          <path d="M130 141 L115 222 L130 371 L145 222Z" fill="rgba(255,255,255,.55)" opacity=".55"/>
          <path d="M111 150 C105 205 102 282 96 358" stroke="#ffffff" stroke-width="2.5" opacity=".55"/>
          <path d="M149 150 C155 205 158 282 164 358" stroke="#ffffff" stroke-width="2.5" opacity=".55"/>
          <path d="M211 42 L223 365" stroke="url(#v268Blade)" stroke-width="8" stroke-linecap="round" filter="url(#v268Glow)"/>
          <path d="M211 42 L223 365" stroke="#78e9ff" stroke-width="2.4" stroke-linecap="round" opacity=".8"/>
          <path d="M209 38 L228 38 L218 8Z" fill="url(#v268Gold)" filter="url(#v268Glow)"/>
          <path d="M38 377 C76 358 184 358 222 377 C194 411 66 411 38 377Z" fill="rgba(255,255,255,.12)" stroke="#ffe28a" stroke-width="1.5" opacity=".7"/>
        </svg>
