...
export const STORY_QUESTS: MainQuestDef[] = [
  ...
  },
  {
    ...
    order: 5,
    title: "乡间美味",
    description: "王大婶请你从万象食案的基础页学会几道标准菜，先把备料、火候和份量做稳。",
    npcId: "wang_dashen",
  ...
  },
  {
    ...
    order: 8,
    title: "林老的嘱托",
    description: "林老要建立一批草药的来源与炮制对照样，请采集10份草药并保留采集信息。",
    npcId: "lin_lao",
    objectives: [
      {
        type: "deliverItem",
  ...
  },
  {
    ...
    order: 7,
    title: "厨艺精进",
    description: "王大婶准备扩充公共供餐食案，请再掌握几道能稳定复做的菜。",
    npcId: "wang_dashen",
  ...
  },
  {
    ...
    order: 4,
    title: "美食家",
    description: "胖婶请你把豆乳初制品接入更多料理，验证不同批次在食案中的表现。",
    npcId: "pang_shen",
  ...
  },
  {
    ...
    order: 8,
    title: "出货达人",
    description: "何掌柜请你补齐集仓供样种类，让采购方能按来源和用途比较不同物产。",
    npcId: "he_zhanggui",
  ...
  },
  {
    ...
    order: 9,
    title: "技艺精通",
    description: "林老认为可靠工序必须能重复执行，请把任意一项百艺练到7级。",
    npcId: "lin_lao",
  ...
  },
  {
    ...
    order: 5,
    title: "大厨之路",
    description: "王大婶请你继续扩展万象食案，并为复杂供餐准备更多标准菜。",
    npcId: "wang_dashen",
  ...
  },
  {
    ...
    order: 7,
    title: "物流大亨",
    description: "何掌柜请你扩大可追溯出货种类，为集仓建立更完整的供样目录。",
    npcId: "he_zhanggui",
  ...
  },
  {
    ...
    order: 4,
    title: "全能大师",
    description: "林老请你让所有百艺达到可独立复核的水准，把各项百艺提升到8级。",
    npcId: "lin_lao",
    objectives: [
  ...
  },
  {
    ...
    order: 5,
    title: "御厨",
    description: "王大婶邀请你完善万象食案的百菜记录，让每份料理都有稳定工序。",
    npcId: "wang_dashen",
  ...
  },
  {
    ...
    order: 8,
    title: "出货全鉴",
    description: "何掌柜希望你完成万象货谱，让每类物产都留下至少一次真实出货记录。",
    npcId: "he_zhanggui",
