...
export type MarketCategory =
  "crop" | "fish" | "animal_product" | "processed" | "fruit" | "ore" | "gem";
...
const SEASON_COEFFICIENTS: Record<
  MarketCategory,
...
/** 供需阈值：7天累计出货量 */
const SUPPLY_THRESHOLDS: Record<
  MarketCategory,
...
export const getMarketMultiplier = (
  ...
  const info = getDailyMarketInfo(
    ...
    seasonIndex,
    day,
    recentCategoryVolume !== undefined
      ? { [category]: recentCategoryVolume }
      : undefined,
  );
