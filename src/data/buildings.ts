...
export const getCellarUpgrade = (level: number): CellarUpgradeDef | undefined =>
  CELLAR_UPGRADES.find((u) => u.level === level);

export const getFarmhouseUpgrade = (
  level: number,
): FarmhouseUpgradeDef | undefined => {
