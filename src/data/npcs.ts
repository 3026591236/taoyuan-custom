...
export const NPCS: NpcDef[] = [
  ...
  },
  {
    ...
    dialogues: {
      ...
      bestFriend: [
        "以后我要盖全村最大的房子！{title}帮我设计？",
        "{player}是我最好的朋友！……别告诉别人啊。",
      ],
    },
  },
  ...
  // ============================================================
  {
    ...
    dialogues: {
      stranger: [
        "请进，喝杯茶吧。我是春兰，这茶庄是祖上传下来的。",
        "{title}若喜欢喝茶，以后常来坐坐。",
      ],
      acquaintance: [
        "今日泡的是明前龙井，{title}尝尝？",
        "采茶要赶在清晨露珠未干时，那时的叶子最嫩。",
      ],
      friendly: [
        "{player}的口味我记住了，特意留了你喜欢的茶。",
        "我家有几亩茶园，改天带{title}去看看。",
      ],
      bestFriend: [
        "和{title}品茶的时光，是我一天中最期待的事。",
        "这盏茶，只为{player}而泡。",
      ],
    },
    marriageable: true,
  ...
  // ============================================================
  {
    ...
    dialogues: {
      stranger: [
        "哎哟，新来的吧？瘦得跟竹竿似的，来来来，婶子给你盛碗饭！",
        "我是王大婶，村里红白喜事的大厨！",
      ],
      acquaintance: [
        "{title}今天吃了没？没吃我给你热碗粥。",
        "做菜的秘诀就是——盐要少放，爱要多放。",
      ],
      friendly: [
        "{player}越来越壮实了，看来没少吃婶子做的饭！",
        "这是婶子的拿手菜，{title}尝尝。",
      ],
      bestFriend: [
        "{player}就跟我自己孩子似的，看着你忙里忙外，婶子心疼。",
        "啥时候成家啊？婶子给你操办酒席！",
      ],
    },
  },
  ...
  },
  {
    ...
    dialogues: {
      ...
      friendly: [
        "{player}的钓术进步了，有点老夫当年的意思。",
        '这个钓法叫"落叶钩"，传给{title}了。',
      ],
      bestFriend: [
        "一竿一线一壶酒，有{player}作伴，不枉此生。",
        "老夫的毕生所学，都交给{title}了。",
      ],
    },
  },
  ...
  },
  {
    ...
    dialogues: {
      stranger: [
        "哎哟{title}！我是马六，走南闯北的行商！稀罕玩意儿多了去了！",
        "来来来看看，保证外面买不到！",
      ],
      acquaintance: [
        "{title}来啦！今天给你看点好东西——独家的！",
        "做生意讲的是诚信……嘿嘿，当然还有利润。",
      ],
      friendly: [
        "{player}，老熟客了，给你打个八折！",
        "我走遍天下，就{title}这村子最让人舒坦。",
      ],
      bestFriend: [
        "{player}是我最信得过的人，这些好货你先挑。",
        "别看我油嘴滑舌的，{title}面前我说的都是真心话。",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    dialogues: {
      ...
      acquaintance: [
        "今天的豆腐脑特别嫩，{title}来一碗？",
        "做豆腐最重要的是水要好，我们村的泉水一流！",
      ],
      friendly: [
        "{player}，给你留了块老豆腐，拿去炖汤！",
        "你是个实在人，不像马六那个滑头。",
      ],
      bestFriend: [
        "{player}什么时候请婶子吃喜酒啊？",
  ...
  },
  {
    ...
    dialogues: {
      stranger: [
        "来来来！进来喝一杯！我是老陆！",
        "人生在世，不喝酒多无趣啊！{title}你说是不是？",
      ],
      acquaintance: [
        "{title}！来来来，今天试试新酿的桃花酒！",
        "红豆那丫头酿酒天赋比我都高……嘿。",
      ],
      friendly: [
        "{player}啊，你这人实在，老陆就喜欢跟实在人喝酒。",
        "这坛三年陈的好酒，给{title}留着呢。",
      ],
      bestFriend: [
        "能跟{player}对饮，是老陆这辈子的幸事。",
        "{title}，来，干了这杯！",
      ],
    },
  },
  ...
  },
  {
    ...
    dialogues: {
      ...
      friendly: [
        "{player}，这药丸是我练习做的，你、你试试？",
        "有{title}来聊天，我就不那么紧张了。",
      ],
      bestFriend: [
        "和{player}在一起……我好像变勇敢了一点。",
        "{title}的体力补剂，我一定用心做。",
      ],
    },
  },
  {
    ...
    dialogues: {
      ...
      bestFriend: [
        "论起{player}的为人，全村没一个不竖大拇指的。",
        "{title}的茶钱？免了免了！老朋友还收什么钱。",
      ],
    },
  },
  {
