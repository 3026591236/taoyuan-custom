...
const MISC_ITEMS: ItemDef[] = [
  ...
  },
  {
    ...
    name: '聚气丹',
    category: 'food',
    description: '蕴灵稻与灵气炼成的丹药，服后增加修为。',
    sellPrice: 320,
    edible: true,
    staminaRestore: 25,
    healthRestore: 8
  },
  {
    ...
    name: '筑基丹',
    category: 'food',
    description: '朱果、凝露草与大量灵气炼成的丹药，可辅助突破。',
    sellPrice: 1200,
    edible: true,
    staminaRestore: 45,
    healthRestore: 20
  ...
  { id: 'yuzhu', name: '玉竹', category: 'material', description: '百草园药材，养阴润燥，可入炼虚、补灵等丹。', sellPrice: 35, edible: false },
  { id: 'baizhi', name: '白芷', category: 'material', description: '百草园药材，祛风散寒，常用于炼精与化神丹。', sellPrice: 35, edible: false },
  { id: 'chishao', name: '赤芍', category: 'material', description: '百草园药材，清热凉血，中阶丹方常用。', sellPrice: 55, edible: false },
  { id: 'chenxiang', name: '沉香', category: 'material', description: '百草园药材，理气止痛，蕴含温和木火灵性。', sellPrice: 55, edible: false },
  { id: 'chonglou', name: '重楼', category: 'material', description: '百草园药材，清热解毒，可炼化气、化神等丹。', sellPrice: 55, edible: false },
  { id: 'suoyang', name: '锁阳', category: 'material', description: '百草园药材，补肾壮阳，炼精与化神丹的重要辅药。', sellPrice: 85, edible: false },
  { id: 'ziwan', name: '紫菀', category: 'material', description: '百草园药材，润肺化痰，高阶延寿、轮回丹常用。', sellPrice: 85, edible: false },
  { id: 'peilan', name: '佩兰', category: 'material', description: '百草园药材，芳香化湿，是炼神、合道丹辅材。', sellPrice: 85, edible: false },
  { id: 'shenqu', name: '神曲', category: 'material', description: '百草园稀有药材，消食化积，可调和高阶丹性。', sellPrice: 160, edible: false },
  { id: 'longkui', name: '龙葵', category: 'material', description: '百草园珍稀药材，蕴含龙气，是延寿、洗髓、轮回丹关键材料。', sellPrice: 360, edible: false },
  { id: 'spirit_dust', name: '灵砂', category: 'material', description: '灵石打磨后残留的细砂，可用于阵法描纹。', sellPrice: 60, edible: false },
  ...
  { id: 'forge_blueprint', name: '炼器图纸', category: 'material', description: '记载古法炼器的残图，可在15转装备升星高星阶段消耗，也可在洞府灵石坊折灵。', sellPrice: 500, edible: false },
  ...
  { id: 'true_spirit_record', name: '真灵秘录', category: 'material', description: '记载上古真灵气息的秘录，二转后会作为轮回殿转生凭证。', sellPrice: 880, edible: false },
  { id: 'reincarnation_dust', name: '轮回尘', category: 'material', description: '轮回缝隙中飘落的尘砂，二转后用于稳定轮回转生。', sellPrice: 960, edible: false },
  { id: 'lingyun_jade', name: '灵蕴玉', category: 'material', description: '镇压凶兽后凝出的灵玉，高转轮回时会提升转生后的灵蕴底蕴。', sellPrice: 1200, edible: false },
  { id: 'artifact_shard', name: '法宝碎片', category: 'material', description: '破碎法宝残片，可用于灵剑淬炼、本命法宝蕴养，也可在洞府折灵。', sellPrice: 520, edible: false },
  { id: 'star_iron', name: '星陨铁', category: 'ore', description: '自天外坠落的奇铁，可用于高阶订单、洞府折灵，也是15转装备升星的核心材料。', sellPrice: 760, edible: false },
  { id: 'moonlight_jade', name: '月华玉', category: 'material', description: '月华凝成的温润灵玉，可用于法衣淬炼、护魂丹药与洞府折灵。', sellPrice: 460, edible: false },
  { id: 'sunfire_crystal', name: '日炎晶', category: 'material', description: '日火灵脉中析出的赤色晶核，可用于灵剑淬炼和火系丹引。', sellPrice: 520, edible: false },
  { id: 'mystic_iron', name: '玄铁', category: 'ore', description: '比精铁更沉的黑色灵矿，是炼器、工坊订单与洞府折灵的通用材料。', sellPrice: 420, edible: false },
  { id: 'cold_jade', name: '寒髓玉', category: 'material', description: '寒潭深处凝成的玉髓，可稳固经脉，适合淬炼护符与炼制清心丹。', sellPrice: 560, edible: false },
  { id: 'phoenix_plume', name: '凤羽', category: 'material', description: '传说灵禽遗落的赤金羽，可作为云靴、法衣和高阶宗门订单材料。', sellPrice: 680, edible: false },
  { id: 'dragon_scale', name: '龙鳞', category: 'material', description: '带有龙脉气息的鳞片，可用于高阶护符、法衣淬炼与轮回准备。', sellPrice: 900, edible: false },
  { id: 'void_dust', name: '太虚尘', category: 'material', description: '太虚裂隙中飘出的灰银尘砂，可用于元神、洞府阵法与高阶折灵。', sellPrice: 980, edible: false },
  { id: 'immortal_dew', name: '仙露', category: 'material', description: '灵脉泉眼偶然凝出的清露，可入高阶丹方，也可在宗门订单中换取贡献。', sellPrice: 620, edible: false },
  { id: 'spirit_bone', name: '灵骨', category: 'material', description: '高阶妖兽遗留的灵骨，适合炼器打底和凶兽订单交付。', sellPrice: 740, edible: false },
  { id: 'demon_core', name: '妖丹', category: 'material', description: '妖兽体内凝结的内丹，可用于修行装备、丹药和洞府折灵。', sellPrice: 860, edible: false },
  { id: 'jade_slip', name: '玉简', category: 'misc', description: '刻有残缺修行心得的玉简，可用于宗门委派和后续功法扩展。', sellPrice: 500, edible: false },
  { id: 'spirit_ink', name: '灵墨', category: 'material', description: '以灵砂与妖血调成的墨汁，适合制符、阵法和宗门交付。', sellPrice: 380, edible: false },
  { id: 'cloud_silk', name: '云纹丝', category: 'material', description: '云气缠绕的灵丝，可用于法衣、云靴和高阶织造订单。', sellPrice: 540, edible: false },
  { id: 'wood', name: '木材', category: 'material', description: '建造和制作的基础材料。', sellPrice: 5, edible: false },
  { id: 'stone', name: '石料', category: 'material', description: '小屋维护、博物馆修复和基础建设常用的石材。', sellPrice: 4, edible: false },
  { id: 'clay', name: '黏土', category: 'material', description: '修复陶器、烧制器皿与基础建设常用的泥料。', sellPrice: 8, edible: false },
