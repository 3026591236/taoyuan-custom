...
export const MORNING_TIPS: MorningTipDef[] = [
  {
    ...
    message:
      "柳村长说：「欢迎来到万象仙乡！背包里有白菜种子，去农场面板开垦土地、播种吧。」",
  },
  {
    id: "tip_first_till",
    priority: 2,
    ...
    message:
      "柳村长说：「田地要先开垦才能种东西。在农场面板点击「一键操作」→「一键开垦」。」",
  },
  {
    id: "tip_first_plant",
    priority: 3,
    ...
    message:
      "柳村长说：「地开垦好了，去农场面板播种吧。「一键种植」可以批量播种。」",
  },
  {
    id: "tip_first_water",
    priority: 4,
    ...
    message:
      "柳村长说：「种子种下后记得浇水，不浇水作物不会生长。试试「一键浇水」。」",
  },
  {
    ...
    message:
      "柳村长说：「作物成熟了！去农场面板收获吧，金色地块就是成熟的作物。」",
  },
  {
    id: "tip_sell_crops",
    priority: 6,
    ...
    message:
      "柳村长说：「收获的作物放进农场面板底部的出货箱，次日就能换钱了。」",
  },
  {
  ...
  },
  {
    ...
    message:
      "柳村长说：「学了食谱可以做菜，做出来的饭能恢复体力。去灶台试试。」",
  },
  {
    id: "tip_rain",
    priority: 15,
    ...
    message:
      "柳村长说：「下雨天作物会自动浇水，省了力气。正好可以去做别的事。」",
  },
  {
    ...
    message:
      "柳村长说：「换季了，不同季节能种的作物不一样，去商圈看看新种子吧。」",
  },
  {
    id: "tip_sprinkler",
    priority: 17,
    ...
    message:
      "柳村长说：「种地面积大了浇水很累，加工坊或铁匠铺可以做洒水器自动浇水。」",
  },
  {
    id: "tip_try_animal",
    priority: 18,
