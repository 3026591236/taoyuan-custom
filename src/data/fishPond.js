...
export const POND_UPGRADE_COSTS = {
    2: {
        money: 10000,
        materials: [
            { itemId: 'wood', quantity: 100 },
...
/** 根据鱼种ID查找可养殖定义 */
export const getPondableFish = (fishId) => {
    return PONDABLE_FISH.find(f => f.fishId === fishId);
};
/** 判断鱼是否可养殖 */
export const isPondableFish = (fishId) => {
