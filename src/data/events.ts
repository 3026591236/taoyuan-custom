...
export const SEASON_EVENTS: SeasonEventDef[] = [
  ...
  },
  {
    ...
    narrative: [
      ...
      "顾百川送来集仓按批次备下的年节食材，王大婶依万象食案分灶出餐，林老逐桌核对寒热禁忌。",
      "裴砚川送来一枚新刻的返程牌：「新一年，出入都记得报平安。」",
      "沈听澜和小满把爆竹移到远离草垛与河鸟栖地的空场，确认水桶备好后才点火。",
      "「新的一年，愿每份药、每桌饭、每批货都经得起复核。」林老说。",
  ...
  },
  {
    ...
    narrative: [
      ...
      "秦大叔把果园分级后的鲜果送到供样桌，林老核过食用禁忌后再分给众人。",
  ...
  },
  {
    ...
    narrative: [
      "冬季第8天——腊八节。",
      "寒冬腊月，但村里的灶火烧得旺旺的。",
      "王大婶从清早便按万象食案熬制腊八粥，各户送来的食材先由阿花登记批次，再分锅投料。",
  ...
  },
  {
    ...
    narrative: [
      "冬季第15天——冬至。",
      "北风呼号，但村里的堂屋热气腾腾。",
      "王大婶按人数分好面团与馅料：「冬至食案先保人人有份，再比谁包得漂亮！」",
  ...
  },
  {
    ...
    narrative: [
      "夏季第18天——斗茶大会。",
      "炎炎夏日，最宜品茗。",
      "春兰在广场架起花信茶作的对照茶台，每壶都挂着原料、焙火和冲泡签。",
      "「好茶须好水、好火、好手。今日比的就是这个好字。」",
      "沈听澜带来经水质记录确认可饮的泉水，裴砚川负责稳固茶台。",
      "春兰笑道：「不只比香气，也请把水温、时辰和判断写下来。」",
      "所有集民好感度+5。",
    ],
    interactive: true,
