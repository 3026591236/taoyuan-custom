...
export const HEART_EVENTS: HeartEventDef[] = [
  ...
  // ============================================================
  {
    ...
    scenes: [
      ...
      {
        text: "穿过一片青篁秘林，绕过几块大石头，眼前豁然开朗——一潭碧绿的深水，四周被巨石环抱，阳光透过树缝洒下斑驳的光影。水面平静如镜，偶尔有鱼跃出水面，泛起一圈圈涟漪。",
      },
      {
        ...
        choices: [
          {
            ...
            friendshipChange: 120,
            response:
              '秋月哈哈大笑："这才对嘛！我最讨厌别人让着我了！来来来，准备好——开始！"她熟练地甩出鱼线，动作干净利落，一看就是行家。',
          },
          {
            text: '"我垂钓技术不太行，你教教我吧。"',
            friendshipChange: 80,
          ...
          },
          {
            ...
            friendshipChange: -40,
            response:
              '秋月鼓起腮帮子，一脸不高兴："哼！垂钓可是世界上最棒的事情！算了算了，不跟你计较，等你钓上一条大鱼就知道有多开心了！"',
          },
        ],
      },
      {
        text: '一炷香过后，你们数了数各自的收获。秋月钓了六条，你钓了三条。她笑得前仰后合："哈哈哈！你输啦！请我吃万象行的桂花糕！不许赖账！"',
      },
      {
        text: '收拾鱼竿时，秋月忽然安静下来，望着水面说："其实……这个地方是我小时候爸妈带我来的。那时候我们一家三口坐在这里垂钓，一坐就是一整天。"她回过头冲你笑了笑，"今天能跟你来这里，也很开心！下次再来比过！"',
      },
    ],
  },
  {
    ...
    scenes: [
      ...
      {
        text: '秋月站起来，深吸一口气，然后转过身，露出一个虽然还带着泪水但已经明亮起来的笑容："好了！秋月才不会一直哭哭啼啼的呢！明天雨停了，我们去垂钓吧。我爸妈最高兴看到我开开心心地垂钓了。"她的眼睛闪着光，"而且……有你在，下雨天好像也没那么可怕了。"',
      },
    ],
  },
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: 120,
            response:
              '秋月用力地点点头，眼里闪着骄傲和思念交织的光："她是全万象仙乡最厉害的钓手！比我还厉害一百倍！……我一直想把她的本事全学会，然后教给更多的人。这样她就永远不会被忘记。"',
          },
        ],
      },
      {
      ...
      {
        text: '忽然，秋月转过身来，认真地看着你。夕阳在她的眼睛里跳动。"我一直在想该怎么说……"她难得地有些扭捏，用手指绕着发梢，"你知道吗？自从你来了万象仙乡，我每天都特别特别开心。以前我觉得自己一个人也可以，可是现在……"她深吸一口气，然后一股脑地说出来，"我喜欢你！超级喜欢！比喜欢垂钓还喜欢！这已经是我能说出的最高级别的喜欢了！"说完她涨红了脸，把头埋进膝盖里。',
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    scenes: [
      {
        text: "你正在玄矿幽脉深处采玄矿，忽然听到前方传来一声闷响，紧接着是岩石崩落的声音。你循着声音跑过去，在一处塌方的岩壁旁发现了阿石——他的左腿被一块落石压住，额头上有一道血痕，却咬着牙一声不吭。",
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: -40,
            response:
              '阿石的目光暗了暗："……采玄矿就是我的活。"他别过脸去，不再说话。虽然你最终还是帮他搬开了石头，但气氛变得沉默。',
          },
        ],
      },
      {
        text: "你帮阿石包扎好伤口，扶着他慢慢走出玄矿幽脉。一路上他的表情还是那样面无波澜，但你注意到他走路时刻意把重心偏向你这一边，好像在无声地依靠你。",
      },
      {
        text: '走到玄矿幽脉口时，阿石停下脚步。他从怀里摸出一块石头——表面粗糙，灰扑扑的，毫不起眼。"……给你。"他说，"看着不像，但里面有玉。"他的耳根微微发红，"我……不太会说谢谢。这个代替。"',
      },
    ],
  },
  {
    ...
    scenes: [
      ...
      {
        text: "他带你进入玄矿幽脉，却没有走常规的通道，而是在一处不起眼的裂缝前停下。他侧身钻了进去，你跟在后面，弯弯曲曲地走了很久，通道越来越窄。就在你觉得快要走不动的时候，眼前忽然豁然开朗。",
      },
      {
  ...
  },
  {
    ...
    scenes: [
      {
        text: "连续好几天没有看到阿石。顾百川说他把自己关在家里，叮叮当当地不知道在敲什么。你有些担心，决定去看看。",
      },
      {
  ...
  // --- 阿石 知己 ---
  {
    ...
    scenes: [
      ...
      {
        text: "他带你到玄矿幽脉最深处一个隐秘的角落。岩壁上天然形成了两道并行的矿脉，一金一银，蜿蜒交织却始终不分离。",
      },
      {
        ...
        choices: [
          {
            ...
            friendshipChange: 160,
            response:
              '阿石也将另一块挂在胸前。他抬头看你，目光如玄矿幽脉深处的水晶——安静，却炽热。"嗯。不渝。"',
          },
          {
            text: '"阿石，有你这个知己，我很幸运。"',
            friendshipChange: 120,
        ...
        choices: [
          {
            ...
            friendshipChange: 120,
            response:
              '"那当然！"秋月得意地扬起下巴，"以后这里就是咱们的秘密基地！拉钩！"',
          },
          {
            text: '"这个钓点真的太棒了！"',
            friendshipChange: 80,
            response:
              '"对吧对吧！"秋月开心得直拍手，"只有知己才有资格来这里！"',
          },
        ],
      },
    ],
        ...
        choices: [
          {
            ...
            friendshipChange: 160,
            response:
              '秋月也晃了晃自己手腕上一模一样的手链。"嘿嘿！现在咱们是正式的知己啦！谁也拆不散！"',
          },
          {
            text: '"秋月，你的手艺比垂钓还厉害。"',
            friendshipChange: 120,
            response:
              '"哈哈哈！这个我就不谦虚了！"秋月拍拍你的肩膀，笑得像阳光。"以后有什么事，知己罩你！"',
          },
        ],
      },
    ],
