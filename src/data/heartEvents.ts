...
export const HEART_EVENTS: HeartEventDef[] = [
  ...
  // ============================================================
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        choices: [
          {
            text: '"这首诗写的是对美好生活的向往，就像万象仙乡一样。"',
            friendshipChange: 120,
            response:
              '柳娘的眼睛亮了起来："你也这样觉得吗？父亲给这个村子取名万象仙乡，就是希望这里能像诗中描绘的那样美好。能遇到懂诗的人，真好。"',
          },
          {
            text: '"说实话，我对古诗不太了解……"',
            friendshipChange: 40,
            response:
              '柳娘轻轻笑了："没关系，诗的美妙之处在于感受，不在于懂不懂。你愿意坐下来听我读一首吗？"',
          },
          {
            text: '"比起读诗，我更喜欢干活。"',
            friendshipChange: -40,
            response:
              '柳娘的笑容淡了一些："勤劳当然是好事……不过，偶尔停下脚步也是需要的。"她低下头，继续翻着诗集。',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: "她领你来到集后一座废弃的老祠堂前。推开吱呀作响的木门，里面供着一块古老的石碑，上面刻满了密密麻麻的小字。",
      },
      {
        text: '"这是万象仙乡的族碑。"柳娘轻声说，"上面记载着两百年前的事。万象仙乡并不是一个普通的万象集——它是当年一群人为了躲避战乱，翻山越岭找到这片隐秘山谷后建立的。他们在这里种桃树、修水渠，发誓再也不与外面的纷争有任何牵扯。"',
        choices: [
          {
            text: '"原来如此……难怪这里与世隔绝，像遗世仙乡一般。"',
            friendshipChange: 120,
            response:
              '柳娘点点头，眼眶微红："是啊。我的祖辈们世世代代守着这个秘密。父亲常说，万象仙乡的宁静是用无数人的牺牲换来的，我们必须珍惜。"',
          },
          {
            text: '"你为什么要告诉我这些？"',
            friendshipChange: 80,
            response:
              '柳娘沉默了片刻，轻声道："因为你来到这里之后，一直在用心经营灵田洞天，帮助集民们。我觉得……你是值得信任的人。而且，你先人当年也知道这些。"',
          },
        ],
      },
      {
        text: '柳娘走到石碑前，用手轻轻拂去上面的灰尘："碑上还记着一段预言——「仙乡之兴衰，系于后来者。若有赤心之人重耕此地，万象可再现昔日之盛。」父亲一直相信，这个人就是你。"',
      },
      {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: "你来到集东的桃花园。月光如水，洒在漫天的桃花上，花瓣在夜风中缓缓飘落，宛如一场无声的花雨。柳娘站在园中央的老桃树下，一袭素色衣裙，发间别着一朵新开的桃花。",
      },
      {
        text: '"你来了。"她转过身，月光映着她的脸庞，"我一直在等你。"她走近几步，声音轻得像是怕惊散了花瓣，"有些话，我在心里藏了很久了……"',
      },
      {
        text: '柳娘低下头，双手绞着衣角："你来万象仙乡之前，我以为我会一辈子守着这个小万象集，读我的诗，过平淡的日子。可是你来了以后，一切都不同了。我看着你开荒灵田经营、帮助集民、让这片土地重新焕发生机……我的心里，也像是开了一片桃花。"她抬起头，眼中有泪光闪烁，"我……喜欢你。"',
        choices: [
          {
      ...
      {
        text: "一阵夜风吹过，漫天桃花纷纷扬扬地落下。你和柳娘并肩站在花雨之中，月光温柔地笼罩着一切。这一刻，万象仙乡真的像是人间仙境。远处隐约传来溪水的声音，像是这片土地在轻声祝福。",
      },
    ],
  },
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '几天后，丹青兴冲冲地拿着新写的章节来找你。"你看这段——写的是陈伯的万物铺，从他先人那辈起就在了。还有胖婶的豆腐坊，用的是百年老卤水。"他的文字果然活了起来，满是烟火气。他看着你，目光温柔而感激："这一章的灵感，全因你一句话。我在序言里记下了。"',
      },
    ],
  },
  {
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: 80,
            response:
              '"一言为定。"柳娘小心翼翼地收好那张写满诗句的宣纸。"这是我们的第一页。"',
          },
        ],
      },
    ],
        ...
        choices: [
          {
            ...
            friendshipChange: 160,
            response:
              '柳娘的眼眶微微泛红。"{player}……有你这个知己，是我这辈子最大的幸运。"',
          },
          {
            text: '"柳娘，我一定好好写满它。"',
            friendshipChange: 120,
            response:
              '"嗯。"柳娘轻轻翻开第一页，上面已经写了一行小字："知己如兰，不以无人而不芳。"',
          },
        ],
      },
    ],
...
export const WEDDING_EVENT: HeartEventDef = {
  ...
  scenes: [
    {
      text: "今天是你期盼已久的日子。清晨的阳光洒在万象仙乡的广场上，集民们早早布置好了红绸和灯笼。陈伯在门口笑呵呵地招呼着来客，王大婶忙前忙后张罗着喜宴。",
    },
    {
      text: '你穿上了崭新的喜服，站在广场中央。柳村长作为证婚人，清了清嗓子说道："今日良辰吉日，万象仙乡又添一桩喜事。"人群中响起了喝彩声。',
    },
    {
