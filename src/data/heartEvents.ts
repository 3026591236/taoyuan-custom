...
export const HEART_EVENTS: HeartEventDef[] = [
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '"这是万象仙乡的族碑。"柳娘轻声说，"上面记载着两百年前的事。万象仙乡并不是一个普通的村庄——它是当年一群人为了躲避战乱，翻山越岭找到这片隐秘山谷后建立的。他们在这里种桃树、修水渠，发誓再也不与外面的纷争有任何牵扯。"',
        choices: [
          {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '柳娘低下头，双手绞着衣角："你来万象仙乡之前，我以为我会一辈子守着这个小村庄，读我的诗，过平淡的日子。可是你来了以后，一切都不同了。我看着你开荒种田、帮助乡亲、让这片土地重新焕发生机……我的心里，也像是开了一片桃花。"她抬起头，眼中有泪光闪烁，"我……喜欢你。"',
        choices: [
          {
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: -40,
            response:
              '秋月鼓起腮帮子，一脸不高兴："哼！钓鱼可是世界上最棒的事情！算了算了，不跟你计较，等你钓上一条大鱼就知道有多开心了！"',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '忽然，秋月转过身来，认真地看着你。夕阳在她的眼睛里跳动。"我一直在想该怎么说……"她难得地有些扭捏，用手指绕着发梢，"你知道吗？自从你来了万象仙乡，我每天都特别特别开心。以前我觉得自己一个人也可以，可是现在……"她深吸一口气，然后一股脑地说出来，"我喜欢你！超级喜欢！比喜欢钓鱼还喜欢！这已经是我能说出的最高级别的喜欢了！"说完她涨红了脸，把头埋进膝盖里。',
      },
    ],
  },
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: -40,
            response:
              '阿石的目光暗了暗："……采矿就是我的活。"他别过脸去，不再说话。虽然你最终还是帮他搬开了石头，但气氛变得沉默。',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    scenes: [
      {
        text: "中秋之夜，红豆拉你上了村后的小山丘。她扛了一坛酒，带了两只碗。月亮又大又圆，挂在漆黑的天幕上，下面是万象仙乡的万家灯火。",
      },
      {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: "眼前的景象让你忘记了呼吸——脚下是无边无际的云海，朝阳从云层中升起，把天空染成了金红色。万象仙乡的炊烟从云海中升起，像是一座飘在仙境里的村庄。",
        choices: [
          {
        ...
        choices: [
          {
            ...
            friendshipChange: 160,
            response:
              '阿石也将另一块挂在胸前。他抬头看你，目光如矿洞深处的水晶——安静，却炽热。"嗯。不渝。"',
          },
          {
            text: '"阿石，有你这个知己，我很幸运。"',
            friendshipChange: 120,
        ...
        choices: [
          {
            ...
            friendshipChange: 120,
            response:
              '"对！"大牛拍着胸脯，"以后我的牛就是你的牛！我的牧场就是你的牧场！知己嘛！"',
          },
          {
            text: '"大牛，你比你想象的更会说话。"',
            friendshipChange: 80,
...
export const WEDDING_EVENT: HeartEventDef = {
  ...
  scenes: [
    {
      text: "今天是你期盼已久的日子。清晨的阳光洒在万象仙乡的广场上，村民们早早布置好了红绸和灯笼。陈伯在门口笑呵呵地招呼着来客，王大婶忙前忙后张罗着喜宴。",
    },
    {
