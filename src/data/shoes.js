...
/** 绸缎庄可购买的鞋子 */
export const SHOP_SHOES = SHOES.filter(s => s.shopPrice !== null);
/** 铁匠铺可合成的鞋子 */
export const CRAFTABLE_SHOES = SHOES.filter(s => s.recipe !== null);
/** 怪物掉落鞋子（按矿洞区域） */
export const MONSTER_DROP_SHOES = {
    shallow: [],
...
/** 宝箱掉落鞋子（按矿洞区域） */
export const TREASURE_DROP_SHOES = {
