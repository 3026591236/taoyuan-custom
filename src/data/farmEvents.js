...
// 设计理念：不是系统，是"早晨的一句旁白"
// ==================== 4% 小偷/动物旁白（25条） ====================
export const MORNING_NARRATIONS = [
    // —— 有轻微损失 ——
...
export const NARRATIONS_NO_LOSS = MORNING_NARRATIONS.filter(n => !n.effect || n.effect.type !== 'loseCrop');
// ==================== 0.8% 带选项事件（15条） ====================
export const MORNING_CHOICE_EVENTS = [
    {
        id: 'injured_bird',
...
// ==================== 0.2% 彩蛋（10条） ====================
export const MORNING_EASTER_EGGS = [
    {
