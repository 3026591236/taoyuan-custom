...
/** 获取当前季节、天气和地点可钓到的鱼 */
export const getAvailableFish = (season, weather, location) => {
    return FISH.filter(f => {
        const seasonMatch = f.season.includes(season);
        const weatherMatch = f.weather.includes('any') || f.weather.includes(weather);
