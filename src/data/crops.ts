...
export const CROPS: CropDef[] = [
  // 春季
  {
    ...
    seedPrice: 10,
    deepWatering: false,
    description: "万象集春季短作叶菜，叶脉整齐，适合鲜售，也能进入盐渍工序。",
  ...
  },
  {
    ...
    seedPrice: 15,
    deepWatering: false,
    description: "根肉紧实、耐短期存放，是早春汤食与风干货的稳定原料。",
    economyRole: "早春耐储根菜",
    supplyStage: "preserve",
    uses: ["鲜食", "风干", "煨汤"],
  },
  {
    id: "potato",
  ...
  },
  {
    ...
    seedPrice: 80,
    deepWatering: false,
    description: "采自回岚茶畦的嫩芽，需经摊青、焙香或浸制才能显出层次。",
    regrowth: true,
    regrowthDays: 4,
    maxHarvests: 3,
    economyRole: "慢周转饮材",
  ...
  // 夏季
  {
    ...
    seedPrice: 40,
    deepWatering: false,
    description: "瓜瓤清甜、含水丰足，鲜售回款快，也适合低温发酵与果饮加工。",
    giantCropEligible: true,
    economyRole: "盛夏鲜果",
    supplyStage: "fresh",
    uses: ["鲜售", "发酵", "消暑食谱"],
  },
  {
    ...
    seedPrice: 20,
    deepWatering: false,
    description: "依星澜河支渠灌溉的主粮稻，脱壳后可煮食，也能酿醋、磨浆。",
    economyRole: "夏季主粮",
    supplyStage: "staple",
    uses: ["主食", "酿醋", "磨制"],
  },
  {
    ...
    seedPrice: 50,
    deepWatering: true,
    description: "生于缓流深畦，脆度高、耐炖煮，是河湾水田的代表性产物。",
    economyRole: "深水鲜材",
    supplyStage: "fresh",
    uses: ["炖煮", "脱水", "河务订单"],
  },
  {
    ...
    seedPrice: 15,
    deepWatering: false,
    description: "颗粒细小但油香集中，适合压榨、研磨，是百工作序常用辅料。",
    economyRole: "高值油料",
    supplyStage: "craft",
    uses: ["榨油", "研磨", "调味"],
  },
  // 秋季
  {
    ...
    seedPrice: 50,
    deepWatering: false,
    description: "果肉厚实且耐储，能平衡秋季鲜售波动，适合熬酱和冬储。",
    giantCropEligible: true,
    economyRole: "秋储作物",
    supplyStage: "preserve",
    uses: ["鲜售", "熬酱", "冬储"],
  ...
  },
  {
    ...
    seedPrice: 60,
    deepWatering: false,
    description: "香气清透，采后需迅速分拣，可用于引蜂、窨香与低度发酵。",
    economyRole: "芳香经济作物",
    supplyStage: "craft",
    uses: ["窨香", "引蜂", "发酵"],
  },
  {
    ...
    seedPrice: 15,
    deepWatering: false,
    description: "花期为蜂群提供蜜源，籽实可入榨油工序，是春季双用途田作。",
    economyRole: "蜜源与油料作物",
    supplyStage: "craft",
    uses: ["引蜂", "榨油", "春季订单"],
  },
  ...
  // 秋季新灵植
  {
    ...
    seedPrice: 30,
    deepWatering: false,
    description: "果肉致密、糖分稳定，适合晾藏、温酿与补给类食谱。",
    regrowth: true,
    regrowthDays: 4,
    maxHarvests: 3,
    economyRole: "耐储甜果",
  ...
  },
  {
    ...
    seedPrice: 20,
    deepWatering: false,
    description: "辛香明显、跨秋冬生长，可作腌藏、汤饮与寒季订单原料。",
    economyRole: "寒季辛香料",
    supplyStage: "preserve",
    uses: ["腌藏", "汤饮", "调味"],
  },
  {
    ...
    seedPrice: 12,
    deepWatering: false,
    description: "经霜后叶帮更脆甜，产量稳定，是冬季鲜食与整缸腌藏的基础菜。",
    giantCropEligible: true,
    economyRole: "冬季大宗菜",
    supplyStage: "preserve",
    uses: ["鲜食", "腌藏", "冬季订单"],
  ...
  },
  {
    ...
    seedPrice: 12,
    deepWatering: false,
    description: "耐寒且带清辛味，适合短期鲜售，更适合压缸后长期供应。",
    economyRole: "冬季腌菜原料",
    supplyStage: "preserve",
    uses: ["盐渍", "佐食", "储备"],
  },
  ...
  // 冬季原有灵植
  {
    ...
    seedPrice: 15,
    deepWatering: false,
    description: "在低温中缓慢扎根，成熟后便于磨粉，是寒季主粮保障。",
    economyRole: "冬季主粮",
    supplyStage: "staple",
    uses: ["磨粉", "烘焙", "粮食订单"],
  },
  {
    ...
    seedPrice: 15,
    deepWatering: false,
    description: "辛烈耐藏，可作调味与防潮储备，也是寒季加工常用辅料。",
    economyRole: "耐储辛香料",
    supplyStage: "preserve",
    uses: ["调味", "腌制", "储备"],
  },
  ...
  // 修仙 V0.2：灵植与炼丹
  {
    id: "spirit_rice",
    name: "蕴灵稻",
    seedId: "seed_spirit_rice",
    season: ["spring", "summer"],
    growthDays: 6,
    sellPrice: 260,
    seedPrice: 120,
    deepWatering: false,
    description: "吸纳田间灵气的灵稻，可作为炼制聚气丹的主材。",
  },
  {
    id: "dew_grass",
    name: "凝露草",
    seedId: "seed_dew_grass",
    season: ["spring", "autumn"],
    growthDays: 5,
    sellPrice: 220,
    seedPrice: 100,
    deepWatering: false,
    description: "晨露凝成的灵草，可炼回灵丹，也可辅助筑基丹。",
  },
  {
    id: "vermilion_fruit",
    name: "朱果",
    seedId: "seed_vermilion_fruit",
    season: ["summer", "autumn"],
    growthDays: 9,
    sellPrice: 520,
    seedPrice: 260,
    deepWatering: false,
    description: "火红如玉的灵果，是炼制筑基丹的珍贵主材。",
    regrowth: true,
    regrowthDays: 5,
    maxHarvests: 3,
  },
