/** 天气对采集概率的修正 */
export const WEATHER_FORAGE_MODIFIER = {
    sunny: 1.0,
    rainy: 1.15,
    stormy: 0.8,
    snowy: 0.9,
...
/** 获取当前季节可采集物 */
export const getForageItems = (season) => {
    return FORAGE_ITEMS.filter(f => f.season.includes(season));
};
// ===== 竹林动物遭遇 =====
/** 竹林动物遭遇概率 */
...
export const rollForestEncounter = (season) => {
