...
/** 判断是否为隐藏NPC */
const isHiddenNpcId = (npcId: string): boolean =>
  HIDDEN_NPCS.some((n) => n.id === npcId);
...
/** 关闭心事件对话框并应用友好度变化 */
export const closeHeartEvent = (
  changes: { npcId: string; amount: number }[],
) => {
