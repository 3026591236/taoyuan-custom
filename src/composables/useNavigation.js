...
import { Wheat, Egg, Home, Heart, Building, Users, Store, TreePine, Fish, Pickaxe, Flame, Cog, Wrench, Package, Star, BookOpen, Wallet, ScrollText, User, FlaskConical, Tent, Waves, Sparkles, Trophy, Landmark, Swords } from 'lucide-vue-next';
...
export const navigateToPanel = (panelKey) => {
